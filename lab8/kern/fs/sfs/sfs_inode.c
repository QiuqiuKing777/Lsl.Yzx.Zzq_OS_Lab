...
sfs_io_nolock(struct sfs_fs *sfs, struct sfs_inode *sin, void *buf, off_t offset, size_t *alenp, bool write) {
    ...
    *alenp = 0;
    ...
    //LAB8:EXERCISE1 2312323 HINT: call sfs_bmap_load_nolock, sfs_rbuf, sfs_rblock,etc. read different kind of blocks in file
	/*
	...
	*/
    ...
    //检查endpos是否与块对齐，如果不对齐，计算出最后一块中需要处理的数据大小，获取对应的块号，然后进行读写操作
