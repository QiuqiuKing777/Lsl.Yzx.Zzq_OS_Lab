...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	62d030ef          	jal	ra,ffffffffc0203e8e <memset>
    dtb_init();
...
ffffffffc0200072:	e7258593          	addi	a1,a1,-398 # ffffffffc0203ee0 <etext+0x4>
ffffffffc0200076:	00004517          	auipc	a0,0x4
ffffffffc020007a:	e8a50513          	addi	a0,a0,-374 # ffffffffc0203f00 <etext+0x24>
...
ffffffffc0200096:	5b8030ef          	jal	ra,ffffffffc020364e <proc_init>
...
ffffffffc02000a2:	7fa030ef          	jal	ra,ffffffffc020389c <cpu_idle>
...
ffffffffc02000c0:	e4c50513          	addi	a0,a0,-436 # ffffffffc0203f08 <etext+0x2c>
...
ffffffffc0200186:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc0200188:	0e3030ef          	jal	ra,ffffffffc0203a6a <vprintfmt>
    return cnt;
}
...
ffffffffc02001bc:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001be:	0ad030ef          	jal	ra,ffffffffc0203a6a <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001e2:	d3250513          	addi	a0,a0,-718 # ffffffffc0203f10 <etext+0x34>
{
...
ffffffffc02001f8:	d3c50513          	addi	a0,a0,-708 # ffffffffc0203f30 <etext+0x54>
ffffffffc02001fc:	f99ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200200:	00004597          	auipc	a1,0x4
ffffffffc0200204:	cdc58593          	addi	a1,a1,-804 # ffffffffc0203edc <etext>
ffffffffc0200208:	00004517          	auipc	a0,0x4
ffffffffc020020c:	d4850513          	addi	a0,a0,-696 # ffffffffc0203f50 <etext+0x74>
...
ffffffffc0200220:	d5450513          	addi	a0,a0,-684 # ffffffffc0203f70 <etext+0x94>
...
ffffffffc0200234:	d6050513          	addi	a0,a0,-672 # ffffffffc0203f90 <etext+0xb4>
...
ffffffffc0200262:	d5250513          	addi	a0,a0,-686 # ffffffffc0203fb0 <etext+0xd4>
}
...
ffffffffc0200270:	d7460613          	addi	a2,a2,-652 # ffffffffc0203fe0 <etext+0x104>
ffffffffc0200274:	04900593          	li	a1,73
ffffffffc0200278:	00004517          	auipc	a0,0x4
ffffffffc020027c:	d8050513          	addi	a0,a0,-640 # ffffffffc0203ff8 <etext+0x11c>
{
...
ffffffffc020028c:	d8860613          	addi	a2,a2,-632 # ffffffffc0204010 <etext+0x134>
ffffffffc0200290:	00004597          	auipc	a1,0x4
ffffffffc0200294:	da058593          	addi	a1,a1,-608 # ffffffffc0204030 <etext+0x154>
ffffffffc0200298:	00004517          	auipc	a0,0x4
ffffffffc020029c:	da050513          	addi	a0,a0,-608 # ffffffffc0204038 <etext+0x15c>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002aa:	da260613          	addi	a2,a2,-606 # ffffffffc0204048 <etext+0x16c>
ffffffffc02002ae:	00004597          	auipc	a1,0x4
ffffffffc02002b2:	dc258593          	addi	a1,a1,-574 # ffffffffc0204070 <etext+0x194>
ffffffffc02002b6:	00004517          	auipc	a0,0x4
ffffffffc02002ba:	d8250513          	addi	a0,a0,-638 # ffffffffc0204038 <etext+0x15c>
ffffffffc02002be:	ed7ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc02002c2:	00004617          	auipc	a2,0x4
ffffffffc02002c6:	dbe60613          	addi	a2,a2,-578 # ffffffffc0204080 <etext+0x1a4>
ffffffffc02002ca:	00004597          	auipc	a1,0x4
ffffffffc02002ce:	dd658593          	addi	a1,a1,-554 # ffffffffc02040a0 <etext+0x1c4>
ffffffffc02002d2:	00004517          	auipc	a0,0x4
ffffffffc02002d6:	d6650513          	addi	a0,a0,-666 # ffffffffc0204038 <etext+0x15c>
...
ffffffffc0200310:	da450513          	addi	a0,a0,-604 # ffffffffc02040b0 <etext+0x1d4>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200332:	daa50513          	addi	a0,a0,-598 # ffffffffc02040d8 <etext+0x1fc>
...
ffffffffc020035c:	da890913          	addi	s2,s2,-600 # ffffffffc0204100 <etext+0x224>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200360:	00004497          	auipc	s1,0x4
ffffffffc0200364:	da848493          	addi	s1,s1,-600 # ffffffffc0204108 <etext+0x22c>
        if (argc == MAXARGS - 1) {
ffffffffc0200368:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020036a:	00004b17          	auipc	s6,0x4
ffffffffc020036e:	da6b0b13          	addi	s6,s6,-602 # ffffffffc0204110 <etext+0x234>
        argv[argc ++] = buf;
ffffffffc0200372:	00004a17          	auipc	s4,0x4
ffffffffc0200376:	cbea0a13          	addi	s4,s4,-834 # ffffffffc0204030 <etext+0x154>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	293030ef          	jal	ra,ffffffffc0203e34 <strcmp>
...
ffffffffc02003b4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003b6:	27f030ef          	jal	ra,ffffffffc0203e34 <strcmp>
...
ffffffffc02003f4:	285030ef          	jal	ra,ffffffffc0203e78 <strchr>
...
ffffffffc0200432:	247030ef          	jal	ra,ffffffffc0203e78 <strchr>
...
ffffffffc0200450:	ce450513          	addi	a0,a0,-796 # ffffffffc0204130 <etext+0x254>
...
ffffffffc02004a2:	da250513          	addi	a0,a0,-606 # ffffffffc0205240 <default_pmm_manager+0x530>
...
ffffffffc0200746:	6a6030ef          	jal	ra,ffffffffc0203dec <strlen>
...
ffffffffc0200752:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc0200754:	6fe030ef          	jal	ra,ffffffffc0203e52 <strncmp>
...
ffffffffc02007ea:	64a030ef          	jal	ra,ffffffffc0203e34 <strcmp>
...
ffffffffc0200c1c:	87870713          	addi	a4,a4,-1928 # ffffffffc020d490 <num>
...
ffffffffc0200c26:	e31c                	sd	a5,0(a4)
                if(num>=10){
ffffffffc0200c28:	fcf6f6e3          	bgeu	a3,a5,ffffffffc0200bf4 <interrupt_handler+0x72>
	SBI_CALL_0(SBI_SHUTDOWN);
...
ffffffffc0200c48:	ccc70713          	addi	a4,a4,-820 # ffffffffc0204910 <commands+0x7c8>
...
# added in Lab4,in handle of do_fork return
forkrets:
...
ffffffffc0200e8e:	b9e63603          	ld	a2,-1122(a2) # ffffffffc0205a28 <nbase>
...
ffffffffc02010d4:	88068693          	addi	a3,a3,-1920 # ffffffffc0204950 <commands+0x808>
ffffffffc02010d8:	00004617          	auipc	a2,0x4
ffffffffc02010dc:	88860613          	addi	a2,a2,-1912 # ffffffffc0204960 <commands+0x818>
ffffffffc02010e0:	0f000593          	li	a1,240
ffffffffc02010e4:	00004517          	auipc	a0,0x4
ffffffffc02010e8:	89450513          	addi	a0,a0,-1900 # ffffffffc0204978 <commands+0x830>
ffffffffc02010ec:	b6eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc02010f0:	00004697          	auipc	a3,0x4
ffffffffc02010f4:	92068693          	addi	a3,a3,-1760 # ffffffffc0204a10 <commands+0x8c8>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	86860613          	addi	a2,a2,-1944 # ffffffffc0204960 <commands+0x818>
ffffffffc0201100:	0bd00593          	li	a1,189
ffffffffc0201104:	00004517          	auipc	a0,0x4
ffffffffc0201108:	87450513          	addi	a0,a0,-1932 # ffffffffc0204978 <commands+0x830>
ffffffffc020110c:	b4eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0201110:	00004697          	auipc	a3,0x4
ffffffffc0201114:	92868693          	addi	a3,a3,-1752 # ffffffffc0204a38 <commands+0x8f0>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	84860613          	addi	a2,a2,-1976 # ffffffffc0204960 <commands+0x818>
ffffffffc0201120:	0be00593          	li	a1,190
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	85450513          	addi	a0,a0,-1964 # ffffffffc0204978 <commands+0x830>
ffffffffc020112c:	b2eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201130:	00004697          	auipc	a3,0x4
ffffffffc0201134:	94868693          	addi	a3,a3,-1720 # ffffffffc0204a78 <commands+0x930>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	82860613          	addi	a2,a2,-2008 # ffffffffc0204960 <commands+0x818>
ffffffffc0201140:	0c000593          	li	a1,192
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	83450513          	addi	a0,a0,-1996 # ffffffffc0204978 <commands+0x830>
ffffffffc020114c:	b0eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!list_empty(&free_list));
ffffffffc0201150:	00004697          	auipc	a3,0x4
ffffffffc0201154:	9b068693          	addi	a3,a3,-1616 # ffffffffc0204b00 <commands+0x9b8>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	80860613          	addi	a2,a2,-2040 # ffffffffc0204960 <commands+0x818>
ffffffffc0201160:	0d900593          	li	a1,217
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	81450513          	addi	a0,a0,-2028 # ffffffffc0204978 <commands+0x830>
ffffffffc020116c:	aeeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201170:	00004697          	auipc	a3,0x4
ffffffffc0201174:	84068693          	addi	a3,a3,-1984 # ffffffffc02049b0 <commands+0x868>
ffffffffc0201178:	00003617          	auipc	a2,0x3
ffffffffc020117c:	7e860613          	addi	a2,a2,2024 # ffffffffc0204960 <commands+0x818>
ffffffffc0201180:	0d200593          	li	a1,210
ffffffffc0201184:	00003517          	auipc	a0,0x3
ffffffffc0201188:	7f450513          	addi	a0,a0,2036 # ffffffffc0204978 <commands+0x830>
ffffffffc020118c:	aceff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 3);
ffffffffc0201190:	00004697          	auipc	a3,0x4
ffffffffc0201194:	96068693          	addi	a3,a3,-1696 # ffffffffc0204af0 <commands+0x9a8>
ffffffffc0201198:	00003617          	auipc	a2,0x3
ffffffffc020119c:	7c860613          	addi	a2,a2,1992 # ffffffffc0204960 <commands+0x818>
ffffffffc02011a0:	0d000593          	li	a1,208
ffffffffc02011a4:	00003517          	auipc	a0,0x3
ffffffffc02011a8:	7d450513          	addi	a0,a0,2004 # ffffffffc0204978 <commands+0x830>
ffffffffc02011ac:	aaeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011b0:	00004697          	auipc	a3,0x4
ffffffffc02011b4:	92868693          	addi	a3,a3,-1752 # ffffffffc0204ad8 <commands+0x990>
ffffffffc02011b8:	00003617          	auipc	a2,0x3
ffffffffc02011bc:	7a860613          	addi	a2,a2,1960 # ffffffffc0204960 <commands+0x818>
ffffffffc02011c0:	0cb00593          	li	a1,203
ffffffffc02011c4:	00003517          	auipc	a0,0x3
ffffffffc02011c8:	7b450513          	addi	a0,a0,1972 # ffffffffc0204978 <commands+0x830>
ffffffffc02011cc:	a8eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc02011d0:	00004697          	auipc	a3,0x4
ffffffffc02011d4:	8e868693          	addi	a3,a3,-1816 # ffffffffc0204ab8 <commands+0x970>
ffffffffc02011d8:	00003617          	auipc	a2,0x3
ffffffffc02011dc:	78860613          	addi	a2,a2,1928 # ffffffffc0204960 <commands+0x818>
ffffffffc02011e0:	0c200593          	li	a1,194
ffffffffc02011e4:	00003517          	auipc	a0,0x3
ffffffffc02011e8:	79450513          	addi	a0,a0,1940 # ffffffffc0204978 <commands+0x830>
ffffffffc02011ec:	a6eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != NULL);
ffffffffc02011f0:	00004697          	auipc	a3,0x4
ffffffffc02011f4:	95868693          	addi	a3,a3,-1704 # ffffffffc0204b48 <commands+0xa00>
ffffffffc02011f8:	00003617          	auipc	a2,0x3
ffffffffc02011fc:	76860613          	addi	a2,a2,1896 # ffffffffc0204960 <commands+0x818>
ffffffffc0201200:	0f800593          	li	a1,248
ffffffffc0201204:	00003517          	auipc	a0,0x3
ffffffffc0201208:	77450513          	addi	a0,a0,1908 # ffffffffc0204978 <commands+0x830>
ffffffffc020120c:	a4eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc0201210:	00004697          	auipc	a3,0x4
ffffffffc0201214:	92868693          	addi	a3,a3,-1752 # ffffffffc0204b38 <commands+0x9f0>
ffffffffc0201218:	00003617          	auipc	a2,0x3
ffffffffc020121c:	74860613          	addi	a2,a2,1864 # ffffffffc0204960 <commands+0x818>
ffffffffc0201220:	0df00593          	li	a1,223
ffffffffc0201224:	00003517          	auipc	a0,0x3
ffffffffc0201228:	75450513          	addi	a0,a0,1876 # ffffffffc0204978 <commands+0x830>
ffffffffc020122c:	a2eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201230:	00004697          	auipc	a3,0x4
ffffffffc0201234:	8a868693          	addi	a3,a3,-1880 # ffffffffc0204ad8 <commands+0x990>
ffffffffc0201238:	00003617          	auipc	a2,0x3
ffffffffc020123c:	72860613          	addi	a2,a2,1832 # ffffffffc0204960 <commands+0x818>
ffffffffc0201240:	0dd00593          	li	a1,221
ffffffffc0201244:	00003517          	auipc	a0,0x3
ffffffffc0201248:	73450513          	addi	a0,a0,1844 # ffffffffc0204978 <commands+0x830>
ffffffffc020124c:	a0eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0201250:	00004697          	auipc	a3,0x4
ffffffffc0201254:	8c868693          	addi	a3,a3,-1848 # ffffffffc0204b18 <commands+0x9d0>
ffffffffc0201258:	00003617          	auipc	a2,0x3
ffffffffc020125c:	70860613          	addi	a2,a2,1800 # ffffffffc0204960 <commands+0x818>
ffffffffc0201260:	0dc00593          	li	a1,220
ffffffffc0201264:	00003517          	auipc	a0,0x3
ffffffffc0201268:	71450513          	addi	a0,a0,1812 # ffffffffc0204978 <commands+0x830>
ffffffffc020126c:	9eeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201270:	00003697          	auipc	a3,0x3
ffffffffc0201274:	74068693          	addi	a3,a3,1856 # ffffffffc02049b0 <commands+0x868>
ffffffffc0201278:	00003617          	auipc	a2,0x3
ffffffffc020127c:	6e860613          	addi	a2,a2,1768 # ffffffffc0204960 <commands+0x818>
ffffffffc0201280:	0b900593          	li	a1,185
ffffffffc0201284:	00003517          	auipc	a0,0x3
ffffffffc0201288:	6f450513          	addi	a0,a0,1780 # ffffffffc0204978 <commands+0x830>
ffffffffc020128c:	9ceff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201290:	00004697          	auipc	a3,0x4
ffffffffc0201294:	84868693          	addi	a3,a3,-1976 # ffffffffc0204ad8 <commands+0x990>
ffffffffc0201298:	00003617          	auipc	a2,0x3
ffffffffc020129c:	6c860613          	addi	a2,a2,1736 # ffffffffc0204960 <commands+0x818>
ffffffffc02012a0:	0d600593          	li	a1,214
ffffffffc02012a4:	00003517          	auipc	a0,0x3
ffffffffc02012a8:	6d450513          	addi	a0,a0,1748 # ffffffffc0204978 <commands+0x830>
ffffffffc02012ac:	9aeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02012b0:	00003697          	auipc	a3,0x3
ffffffffc02012b4:	74068693          	addi	a3,a3,1856 # ffffffffc02049f0 <commands+0x8a8>
ffffffffc02012b8:	00003617          	auipc	a2,0x3
ffffffffc02012bc:	6a860613          	addi	a2,a2,1704 # ffffffffc0204960 <commands+0x818>
ffffffffc02012c0:	0d400593          	li	a1,212
ffffffffc02012c4:	00003517          	auipc	a0,0x3
ffffffffc02012c8:	6b450513          	addi	a0,a0,1716 # ffffffffc0204978 <commands+0x830>
ffffffffc02012cc:	98eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012d0:	00003697          	auipc	a3,0x3
ffffffffc02012d4:	70068693          	addi	a3,a3,1792 # ffffffffc02049d0 <commands+0x888>
ffffffffc02012d8:	00003617          	auipc	a2,0x3
ffffffffc02012dc:	68860613          	addi	a2,a2,1672 # ffffffffc0204960 <commands+0x818>
ffffffffc02012e0:	0d300593          	li	a1,211
ffffffffc02012e4:	00003517          	auipc	a0,0x3
ffffffffc02012e8:	69450513          	addi	a0,a0,1684 # ffffffffc0204978 <commands+0x830>
ffffffffc02012ec:	96eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02012f0:	00003697          	auipc	a3,0x3
ffffffffc02012f4:	70068693          	addi	a3,a3,1792 # ffffffffc02049f0 <commands+0x8a8>
ffffffffc02012f8:	00003617          	auipc	a2,0x3
ffffffffc02012fc:	66860613          	addi	a2,a2,1640 # ffffffffc0204960 <commands+0x818>
ffffffffc0201300:	0bb00593          	li	a1,187
ffffffffc0201304:	00003517          	auipc	a0,0x3
ffffffffc0201308:	67450513          	addi	a0,a0,1652 # ffffffffc0204978 <commands+0x830>
ffffffffc020130c:	94eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(count == 0);
ffffffffc0201310:	00004697          	auipc	a3,0x4
ffffffffc0201314:	98868693          	addi	a3,a3,-1656 # ffffffffc0204c98 <commands+0xb50>
ffffffffc0201318:	00003617          	auipc	a2,0x3
ffffffffc020131c:	64860613          	addi	a2,a2,1608 # ffffffffc0204960 <commands+0x818>
ffffffffc0201320:	12500593          	li	a1,293
ffffffffc0201324:	00003517          	auipc	a0,0x3
ffffffffc0201328:	65450513          	addi	a0,a0,1620 # ffffffffc0204978 <commands+0x830>
ffffffffc020132c:	92eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc0201330:	00004697          	auipc	a3,0x4
ffffffffc0201334:	80868693          	addi	a3,a3,-2040 # ffffffffc0204b38 <commands+0x9f0>
ffffffffc0201338:	00003617          	auipc	a2,0x3
ffffffffc020133c:	62860613          	addi	a2,a2,1576 # ffffffffc0204960 <commands+0x818>
ffffffffc0201340:	11a00593          	li	a1,282
ffffffffc0201344:	00003517          	auipc	a0,0x3
ffffffffc0201348:	63450513          	addi	a0,a0,1588 # ffffffffc0204978 <commands+0x830>
ffffffffc020134c:	90eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201350:	00003697          	auipc	a3,0x3
ffffffffc0201354:	78868693          	addi	a3,a3,1928 # ffffffffc0204ad8 <commands+0x990>
ffffffffc0201358:	00003617          	auipc	a2,0x3
ffffffffc020135c:	60860613          	addi	a2,a2,1544 # ffffffffc0204960 <commands+0x818>
ffffffffc0201360:	11800593          	li	a1,280
ffffffffc0201364:	00003517          	auipc	a0,0x3
ffffffffc0201368:	61450513          	addi	a0,a0,1556 # ffffffffc0204978 <commands+0x830>
ffffffffc020136c:	8eeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201370:	00003697          	auipc	a3,0x3
ffffffffc0201374:	72868693          	addi	a3,a3,1832 # ffffffffc0204a98 <commands+0x950>
ffffffffc0201378:	00003617          	auipc	a2,0x3
ffffffffc020137c:	5e860613          	addi	a2,a2,1512 # ffffffffc0204960 <commands+0x818>
ffffffffc0201380:	0c100593          	li	a1,193
ffffffffc0201384:	00003517          	auipc	a0,0x3
ffffffffc0201388:	5f450513          	addi	a0,a0,1524 # ffffffffc0204978 <commands+0x830>
ffffffffc020138c:	8ceff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201390:	00004697          	auipc	a3,0x4
ffffffffc0201394:	8c868693          	addi	a3,a3,-1848 # ffffffffc0204c58 <commands+0xb10>
ffffffffc0201398:	00003617          	auipc	a2,0x3
ffffffffc020139c:	5c860613          	addi	a2,a2,1480 # ffffffffc0204960 <commands+0x818>
ffffffffc02013a0:	11200593          	li	a1,274
ffffffffc02013a4:	00003517          	auipc	a0,0x3
ffffffffc02013a8:	5d450513          	addi	a0,a0,1492 # ffffffffc0204978 <commands+0x830>
ffffffffc02013ac:	8aeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02013b0:	00004697          	auipc	a3,0x4
ffffffffc02013b4:	88868693          	addi	a3,a3,-1912 # ffffffffc0204c38 <commands+0xaf0>
ffffffffc02013b8:	00003617          	auipc	a2,0x3
ffffffffc02013bc:	5a860613          	addi	a2,a2,1448 # ffffffffc0204960 <commands+0x818>
ffffffffc02013c0:	11000593          	li	a1,272
ffffffffc02013c4:	00003517          	auipc	a0,0x3
ffffffffc02013c8:	5b450513          	addi	a0,a0,1460 # ffffffffc0204978 <commands+0x830>
ffffffffc02013cc:	88eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02013d0:	00004697          	auipc	a3,0x4
ffffffffc02013d4:	84068693          	addi	a3,a3,-1984 # ffffffffc0204c10 <commands+0xac8>
ffffffffc02013d8:	00003617          	auipc	a2,0x3
ffffffffc02013dc:	58860613          	addi	a2,a2,1416 # ffffffffc0204960 <commands+0x818>
ffffffffc02013e0:	10e00593          	li	a1,270
ffffffffc02013e4:	00003517          	auipc	a0,0x3
ffffffffc02013e8:	59450513          	addi	a0,a0,1428 # ffffffffc0204978 <commands+0x830>
ffffffffc02013ec:	86eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02013f0:	00003697          	auipc	a3,0x3
ffffffffc02013f4:	7f868693          	addi	a3,a3,2040 # ffffffffc0204be8 <commands+0xaa0>
ffffffffc02013f8:	00003617          	auipc	a2,0x3
ffffffffc02013fc:	56860613          	addi	a2,a2,1384 # ffffffffc0204960 <commands+0x818>
ffffffffc0201400:	10d00593          	li	a1,269
ffffffffc0201404:	00003517          	auipc	a0,0x3
ffffffffc0201408:	57450513          	addi	a0,a0,1396 # ffffffffc0204978 <commands+0x830>
ffffffffc020140c:	84eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201410:	00003697          	auipc	a3,0x3
ffffffffc0201414:	7c868693          	addi	a3,a3,1992 # ffffffffc0204bd8 <commands+0xa90>
ffffffffc0201418:	00003617          	auipc	a2,0x3
ffffffffc020141c:	54860613          	addi	a2,a2,1352 # ffffffffc0204960 <commands+0x818>
ffffffffc0201420:	10800593          	li	a1,264
ffffffffc0201424:	00003517          	auipc	a0,0x3
ffffffffc0201428:	55450513          	addi	a0,a0,1364 # ffffffffc0204978 <commands+0x830>
ffffffffc020142c:	82eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201430:	00003697          	auipc	a3,0x3
ffffffffc0201434:	6a868693          	addi	a3,a3,1704 # ffffffffc0204ad8 <commands+0x990>
ffffffffc0201438:	00003617          	auipc	a2,0x3
ffffffffc020143c:	52860613          	addi	a2,a2,1320 # ffffffffc0204960 <commands+0x818>
ffffffffc0201440:	10700593          	li	a1,263
ffffffffc0201444:	00003517          	auipc	a0,0x3
ffffffffc0201448:	53450513          	addi	a0,a0,1332 # ffffffffc0204978 <commands+0x830>
ffffffffc020144c:	80eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201450:	00003697          	auipc	a3,0x3
ffffffffc0201454:	76868693          	addi	a3,a3,1896 # ffffffffc0204bb8 <commands+0xa70>
ffffffffc0201458:	00003617          	auipc	a2,0x3
ffffffffc020145c:	50860613          	addi	a2,a2,1288 # ffffffffc0204960 <commands+0x818>
ffffffffc0201460:	10600593          	li	a1,262
ffffffffc0201464:	00003517          	auipc	a0,0x3
ffffffffc0201468:	51450513          	addi	a0,a0,1300 # ffffffffc0204978 <commands+0x830>
ffffffffc020146c:	feffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201470:	00003697          	auipc	a3,0x3
ffffffffc0201474:	71868693          	addi	a3,a3,1816 # ffffffffc0204b88 <commands+0xa40>
ffffffffc0201478:	00003617          	auipc	a2,0x3
ffffffffc020147c:	4e860613          	addi	a2,a2,1256 # ffffffffc0204960 <commands+0x818>
ffffffffc0201480:	10500593          	li	a1,261
ffffffffc0201484:	00003517          	auipc	a0,0x3
ffffffffc0201488:	4f450513          	addi	a0,a0,1268 # ffffffffc0204978 <commands+0x830>
ffffffffc020148c:	fcffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201490:	00003697          	auipc	a3,0x3
ffffffffc0201494:	6e068693          	addi	a3,a3,1760 # ffffffffc0204b70 <commands+0xa28>
ffffffffc0201498:	00003617          	auipc	a2,0x3
ffffffffc020149c:	4c860613          	addi	a2,a2,1224 # ffffffffc0204960 <commands+0x818>
ffffffffc02014a0:	10400593          	li	a1,260
ffffffffc02014a4:	00003517          	auipc	a0,0x3
ffffffffc02014a8:	4d450513          	addi	a0,a0,1236 # ffffffffc0204978 <commands+0x830>
ffffffffc02014ac:	faffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02014b0:	00003697          	auipc	a3,0x3
ffffffffc02014b4:	62868693          	addi	a3,a3,1576 # ffffffffc0204ad8 <commands+0x990>
ffffffffc02014b8:	00003617          	auipc	a2,0x3
ffffffffc02014bc:	4a860613          	addi	a2,a2,1192 # ffffffffc0204960 <commands+0x818>
ffffffffc02014c0:	0fe00593          	li	a1,254
ffffffffc02014c4:	00003517          	auipc	a0,0x3
ffffffffc02014c8:	4b450513          	addi	a0,a0,1204 # ffffffffc0204978 <commands+0x830>
ffffffffc02014cc:	f8ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!PageProperty(p0));
ffffffffc02014d0:	00003697          	auipc	a3,0x3
ffffffffc02014d4:	68868693          	addi	a3,a3,1672 # ffffffffc0204b58 <commands+0xa10>
ffffffffc02014d8:	00003617          	auipc	a2,0x3
ffffffffc02014dc:	48860613          	addi	a2,a2,1160 # ffffffffc0204960 <commands+0x818>
ffffffffc02014e0:	0f900593          	li	a1,249
ffffffffc02014e4:	00003517          	auipc	a0,0x3
ffffffffc02014e8:	49450513          	addi	a0,a0,1172 # ffffffffc0204978 <commands+0x830>
ffffffffc02014ec:	f6ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02014f0:	00003697          	auipc	a3,0x3
ffffffffc02014f4:	78868693          	addi	a3,a3,1928 # ffffffffc0204c78 <commands+0xb30>
ffffffffc02014f8:	00003617          	auipc	a2,0x3
ffffffffc02014fc:	46860613          	addi	a2,a2,1128 # ffffffffc0204960 <commands+0x818>
ffffffffc0201500:	11700593          	li	a1,279
ffffffffc0201504:	00003517          	auipc	a0,0x3
ffffffffc0201508:	47450513          	addi	a0,a0,1140 # ffffffffc0204978 <commands+0x830>
ffffffffc020150c:	f4ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == 0);
ffffffffc0201510:	00003697          	auipc	a3,0x3
ffffffffc0201514:	79868693          	addi	a3,a3,1944 # ffffffffc0204ca8 <commands+0xb60>
ffffffffc0201518:	00003617          	auipc	a2,0x3
ffffffffc020151c:	44860613          	addi	a2,a2,1096 # ffffffffc0204960 <commands+0x818>
ffffffffc0201520:	12600593          	li	a1,294
ffffffffc0201524:	00003517          	auipc	a0,0x3
ffffffffc0201528:	45450513          	addi	a0,a0,1108 # ffffffffc0204978 <commands+0x830>
ffffffffc020152c:	f2ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == nr_free_pages());
ffffffffc0201530:	00003697          	auipc	a3,0x3
ffffffffc0201534:	46068693          	addi	a3,a3,1120 # ffffffffc0204990 <commands+0x848>
ffffffffc0201538:	00003617          	auipc	a2,0x3
ffffffffc020153c:	42860613          	addi	a2,a2,1064 # ffffffffc0204960 <commands+0x818>
ffffffffc0201540:	0f300593          	li	a1,243
ffffffffc0201544:	00003517          	auipc	a0,0x3
ffffffffc0201548:	43450513          	addi	a0,a0,1076 # ffffffffc0204978 <commands+0x830>
ffffffffc020154c:	f0ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201550:	00003697          	auipc	a3,0x3
ffffffffc0201554:	48068693          	addi	a3,a3,1152 # ffffffffc02049d0 <commands+0x888>
ffffffffc0201558:	00003617          	auipc	a2,0x3
ffffffffc020155c:	40860613          	addi	a2,a2,1032 # ffffffffc0204960 <commands+0x818>
ffffffffc0201560:	0ba00593          	li	a1,186
ffffffffc0201564:	00003517          	auipc	a0,0x3
ffffffffc0201568:	41450513          	addi	a0,a0,1044 # ffffffffc0204978 <commands+0x830>
...
ffffffffc02016a0:	62468693          	addi	a3,a3,1572 # ffffffffc0204cc0 <commands+0xb78>
ffffffffc02016a4:	00003617          	auipc	a2,0x3
ffffffffc02016a8:	2bc60613          	addi	a2,a2,700 # ffffffffc0204960 <commands+0x818>
ffffffffc02016ac:	08300593          	li	a1,131
ffffffffc02016b0:	00003517          	auipc	a0,0x3
ffffffffc02016b4:	2c850513          	addi	a0,a0,712 # ffffffffc0204978 <commands+0x830>
ffffffffc02016b8:	da3fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc02016bc:	00003697          	auipc	a3,0x3
ffffffffc02016c0:	5fc68693          	addi	a3,a3,1532 # ffffffffc0204cb8 <commands+0xb70>
ffffffffc02016c4:	00003617          	auipc	a2,0x3
ffffffffc02016c8:	29c60613          	addi	a2,a2,668 # ffffffffc0204960 <commands+0x818>
ffffffffc02016cc:	08000593          	li	a1,128
ffffffffc02016d0:	00003517          	auipc	a0,0x3
ffffffffc02016d4:	2a850513          	addi	a0,a0,680 # ffffffffc0204978 <commands+0x830>
...
ffffffffc0201772:	54a68693          	addi	a3,a3,1354 # ffffffffc0204cb8 <commands+0xb70>
ffffffffc0201776:	00003617          	auipc	a2,0x3
ffffffffc020177a:	1ea60613          	addi	a2,a2,490 # ffffffffc0204960 <commands+0x818>
ffffffffc020177e:	06200593          	li	a1,98
ffffffffc0201782:	00003517          	auipc	a0,0x3
ffffffffc0201786:	1f650513          	addi	a0,a0,502 # ffffffffc0204978 <commands+0x830>
default_alloc_pages(size_t n) {
...
ffffffffc0201844:	4a868693          	addi	a3,a3,1192 # ffffffffc0204ce8 <commands+0xba0>
ffffffffc0201848:	00003617          	auipc	a2,0x3
ffffffffc020184c:	11860613          	addi	a2,a2,280 # ffffffffc0204960 <commands+0x818>
ffffffffc0201850:	04900593          	li	a1,73
ffffffffc0201854:	00003517          	auipc	a0,0x3
ffffffffc0201858:	12450513          	addi	a0,a0,292 # ffffffffc0204978 <commands+0x830>
ffffffffc020185c:	bfffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc0201860:	00003697          	auipc	a3,0x3
ffffffffc0201864:	45868693          	addi	a3,a3,1112 # ffffffffc0204cb8 <commands+0xb70>
ffffffffc0201868:	00003617          	auipc	a2,0x3
ffffffffc020186c:	0f860613          	addi	a2,a2,248 # ffffffffc0204960 <commands+0x818>
ffffffffc0201870:	04600593          	li	a1,70
ffffffffc0201874:	00003517          	auipc	a0,0x3
ffffffffc0201878:	10450513          	addi	a0,a0,260 # ffffffffc0204978 <commands+0x830>
...
ffffffffc0201954:	0d86b683          	ld	a3,216(a3) # ffffffffc0205a28 <nbase>
...
ffffffffc0201984:	3c860613          	addi	a2,a2,968 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201988:	07100593          	li	a1,113
ffffffffc020198c:	00003517          	auipc	a0,0x3
ffffffffc0201990:	3e450513          	addi	a0,a0,996 # ffffffffc0204d70 <default_pmm_manager+0x60>
...
ffffffffc0201a72:	31268693          	addi	a3,a3,786 # ffffffffc0204d80 <default_pmm_manager+0x70>
ffffffffc0201a76:	00003617          	auipc	a2,0x3
ffffffffc0201a7a:	eea60613          	addi	a2,a2,-278 # ffffffffc0204960 <commands+0x818>
ffffffffc0201a7e:	06300593          	li	a1,99
ffffffffc0201a82:	00003517          	auipc	a0,0x3
ffffffffc0201a86:	31e50513          	addi	a0,a0,798 # ffffffffc0204da0 <default_pmm_manager+0x90>
...
ffffffffc0201a94:	32850513          	addi	a0,a0,808 # ffffffffc0204db8 <default_pmm_manager+0xa8>
{
...
ffffffffc0201aa4:	33050513          	addi	a0,a0,816 # ffffffffc0204dd0 <default_pmm_manager+0xc0>
}
...
ffffffffc0201bc8:	e6453503          	ld	a0,-412(a0) # ffffffffc0205a28 <nbase>
...
ffffffffc0201c26:	1f660613          	addi	a2,a2,502 # ffffffffc0204e18 <default_pmm_manager+0x108>
ffffffffc0201c2a:	06900593          	li	a1,105
ffffffffc0201c2e:	00003517          	auipc	a0,0x3
ffffffffc0201c32:	14250513          	addi	a0,a0,322 # ffffffffc0204d70 <default_pmm_manager+0x60>
...
ffffffffc0201c40:	1b460613          	addi	a2,a2,436 # ffffffffc0204df0 <default_pmm_manager+0xe0>
ffffffffc0201c44:	07700593          	li	a1,119
ffffffffc0201c48:	00003517          	auipc	a0,0x3
ffffffffc0201c4c:	12850513          	addi	a0,a0,296 # ffffffffc0204d70 <default_pmm_manager+0x60>
...
ffffffffc0201c5a:	1c260613          	addi	a2,a2,450 # ffffffffc0204e18 <default_pmm_manager+0x108>
ffffffffc0201c5e:	06900593          	li	a1,105
ffffffffc0201c62:	00003517          	auipc	a0,0x3
ffffffffc0201c66:	10e50513          	addi	a0,a0,270 # ffffffffc0204d70 <default_pmm_manager+0x60>
pa2page(uintptr_t pa)
...
ffffffffc0201c76:	1c660613          	addi	a2,a2,454 # ffffffffc0204e38 <default_pmm_manager+0x128>
ffffffffc0201c7a:	07f00593          	li	a1,127
ffffffffc0201c7e:	00003517          	auipc	a0,0x3
ffffffffc0201c82:	0f250513          	addi	a0,a0,242 # ffffffffc0204d70 <default_pmm_manager+0x60>
pte2page(pte_t pte)
...
ffffffffc0201ddc:	0b2020ef          	jal	ra,ffffffffc0203e8e <memset>
    return page - pages + nbase;
...
ffffffffc0201e7e:	010020ef          	jal	ra,ffffffffc0203e8e <memset>
    return page - pages + nbase;
...
ffffffffc0201f0c:	e4060613          	addi	a2,a2,-448 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201f10:	0ff00593          	li	a1,255
ffffffffc0201f14:	00003517          	auipc	a0,0x3
ffffffffc0201f18:	f4c50513          	addi	a0,a0,-180 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0201f1c:	d3efe0ef          	jal	ra,ffffffffc020045a <__panic>
    pde_t *pdep0 = &((pte_t *)KADDR(PDE_ADDR(*pdep1)))[PDX0(la)];//level 2//find big page//再下一级页表
ffffffffc0201f20:	00003617          	auipc	a2,0x3
ffffffffc0201f24:	e2860613          	addi	a2,a2,-472 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201f28:	0f100593          	li	a1,241
ffffffffc0201f2c:	00003517          	auipc	a0,0x3
ffffffffc0201f30:	f3450513          	addi	a0,a0,-204 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0201f3e:	e0e60613          	addi	a2,a2,-498 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201f42:	0ee00593          	li	a1,238
ffffffffc0201f46:	00003517          	auipc	a0,0x3
ffffffffc0201f4a:	f1a50513          	addi	a0,a0,-230 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0201f58:	df460613          	addi	a2,a2,-524 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0201f5c:	0fc00593          	li	a1,252
ffffffffc0201f60:	00003517          	auipc	a0,0x3
ffffffffc0201f64:	f0050513          	addi	a0,a0,-256 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0202156:	bbe78793          	addi	a5,a5,-1090 # ffffffffc0204d10 <default_pmm_manager>
...
ffffffffc0202164:	d1050513          	addi	a0,a0,-752 # ffffffffc0204e70 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc02021b8:	cf450513          	addi	a0,a0,-780 # ffffffffc0204ea8 <default_pmm_manager+0x198>
...
ffffffffc02021d0:	cf450513          	addi	a0,a0,-780 # ffffffffc0204ec0 <default_pmm_manager+0x1b0>
...
ffffffffc0202258:	c9450513          	addi	a0,a0,-876 # ffffffffc0204ee8 <default_pmm_manager+0x1d8>
...
ffffffffc0202274:	c9050513          	addi	a0,a0,-880 # ffffffffc0204f00 <default_pmm_manager+0x1f0>
...
ffffffffc020252a:	d0250513          	addi	a0,a0,-766 # ffffffffc0205228 <default_pmm_manager+0x518>
...
ffffffffc02025ee:	d8658593          	addi	a1,a1,-634 # ffffffffc0205370 <default_pmm_manager+0x660>
ffffffffc02025f2:	10000513          	li	a0,256
ffffffffc02025f6:	02d010ef          	jal	ra,ffffffffc0203e22 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02025fa:	10040593          	addi	a1,s0,256
ffffffffc02025fe:	10000513          	li	a0,256
ffffffffc0202602:	033010ef          	jal	ra,ffffffffc0203e34 <strcmp>
...
ffffffffc0202634:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202638:	7b4010ef          	jal	ra,ffffffffc0203dec <strlen>
...
ffffffffc02026fc:	cf050513          	addi	a0,a0,-784 # ffffffffc02053e8 <default_pmm_manager+0x6d8>
...
ffffffffc0202864:	4e860613          	addi	a2,a2,1256 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0202868:	1b400593          	li	a1,436
ffffffffc020286c:	00002517          	auipc	a0,0x2
ffffffffc0202870:	5f450513          	addi	a0,a0,1524 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202874:	be7fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202878:	00003697          	auipc	a3,0x3
ffffffffc020287c:	a1068693          	addi	a3,a3,-1520 # ffffffffc0205288 <default_pmm_manager+0x578>
ffffffffc0202880:	00002617          	auipc	a2,0x2
ffffffffc0202884:	0e060613          	addi	a2,a2,224 # ffffffffc0204960 <commands+0x818>
ffffffffc0202888:	1b500593          	li	a1,437
ffffffffc020288c:	00002517          	auipc	a0,0x2
ffffffffc0202890:	5d450513          	addi	a0,a0,1492 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202894:	bc7fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert((ptep = get_pte(boot_pgdir_va, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202898:	00003697          	auipc	a3,0x3
ffffffffc020289c:	9b068693          	addi	a3,a3,-1616 # ffffffffc0205248 <default_pmm_manager+0x538>
ffffffffc02028a0:	00002617          	auipc	a2,0x2
ffffffffc02028a4:	0c060613          	addi	a2,a2,192 # ffffffffc0204960 <commands+0x818>
ffffffffc02028a8:	1b400593          	li	a1,436
ffffffffc02028ac:	00002517          	auipc	a0,0x2
ffffffffc02028b0:	5b450513          	addi	a0,a0,1460 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc02028c4:	78068693          	addi	a3,a3,1920 # ffffffffc0205040 <default_pmm_manager+0x330>
ffffffffc02028c8:	00002617          	auipc	a2,0x2
ffffffffc02028cc:	09860613          	addi	a2,a2,152 # ffffffffc0204960 <commands+0x818>
ffffffffc02028d0:	17e00593          	li	a1,382
ffffffffc02028d4:	00002517          	auipc	a0,0x2
ffffffffc02028d8:	58c50513          	addi	a0,a0,1420 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02028dc:	b7ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(get_page(boot_pgdir_va, 0x0, NULL) == NULL);//addr 0 not projected
ffffffffc02028e0:	00002697          	auipc	a3,0x2
ffffffffc02028e4:	6a068693          	addi	a3,a3,1696 # ffffffffc0204f80 <default_pmm_manager+0x270>
ffffffffc02028e8:	00002617          	auipc	a2,0x2
ffffffffc02028ec:	07860613          	addi	a2,a2,120 # ffffffffc0204960 <commands+0x818>
ffffffffc02028f0:	17100593          	li	a1,369
ffffffffc02028f4:	00002517          	auipc	a0,0x2
ffffffffc02028f8:	56c50513          	addi	a0,a0,1388 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02028fc:	b5ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va != NULL && (uint32_t)PGOFF(boot_pgdir_va) == 0);//page directory addr valid and aligned
ffffffffc0202900:	00002697          	auipc	a3,0x2
ffffffffc0202904:	64068693          	addi	a3,a3,1600 # ffffffffc0204f40 <default_pmm_manager+0x230>
ffffffffc0202908:	00002617          	auipc	a2,0x2
ffffffffc020290c:	05860613          	addi	a2,a2,88 # ffffffffc0204960 <commands+0x818>
ffffffffc0202910:	17000593          	li	a1,368
ffffffffc0202914:	00002517          	auipc	a0,0x2
ffffffffc0202918:	54c50513          	addi	a0,a0,1356 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc020291c:	b3ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(npage <= KERNTOP / PGSIZE);//p page not over pm top
ffffffffc0202920:	00002697          	auipc	a3,0x2
ffffffffc0202924:	60068693          	addi	a3,a3,1536 # ffffffffc0204f20 <default_pmm_manager+0x210>
ffffffffc0202928:	00002617          	auipc	a2,0x2
ffffffffc020292c:	03860613          	addi	a2,a2,56 # ffffffffc0204960 <commands+0x818>
ffffffffc0202930:	16f00593          	li	a1,367
ffffffffc0202934:	00002517          	auipc	a0,0x2
ffffffffc0202938:	52c50513          	addi	a0,a0,1324 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc020293c:	b1ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    return KADDR(page2pa(page));
ffffffffc0202940:	00002617          	auipc	a2,0x2
ffffffffc0202944:	40860613          	addi	a2,a2,1032 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0202948:	07100593          	li	a1,113
ffffffffc020294c:	00002517          	auipc	a0,0x2
ffffffffc0202950:	42450513          	addi	a0,a0,1060 # ffffffffc0204d70 <default_pmm_manager+0x60>
ffffffffc0202954:	b07fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(pde2page(boot_pgdir_va[0])) == 1);
ffffffffc0202958:	00003697          	auipc	a3,0x3
ffffffffc020295c:	87868693          	addi	a3,a3,-1928 # ffffffffc02051d0 <default_pmm_manager+0x4c0>
ffffffffc0202960:	00002617          	auipc	a2,0x2
ffffffffc0202964:	00060613          	mv	a2,a2
ffffffffc0202968:	19c00593          	li	a1,412
ffffffffc020296c:	00002517          	auipc	a0,0x2
ffffffffc0202970:	4f450513          	addi	a0,a0,1268 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202974:	ae7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202978:	00003697          	auipc	a3,0x3
ffffffffc020297c:	81068693          	addi	a3,a3,-2032 # ffffffffc0205188 <default_pmm_manager+0x478>
ffffffffc0202980:	00002617          	auipc	a2,0x2
ffffffffc0202984:	fe060613          	addi	a2,a2,-32 # ffffffffc0204960 <commands+0x818>
ffffffffc0202988:	19a00593          	li	a1,410
ffffffffc020298c:	00002517          	auipc	a0,0x2
ffffffffc0202990:	4d450513          	addi	a0,a0,1236 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202994:	ac7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202998:	00003697          	auipc	a3,0x3
ffffffffc020299c:	82068693          	addi	a3,a3,-2016 # ffffffffc02051b8 <default_pmm_manager+0x4a8>
ffffffffc02029a0:	00002617          	auipc	a2,0x2
ffffffffc02029a4:	fc060613          	addi	a2,a2,-64 # ffffffffc0204960 <commands+0x818>
ffffffffc02029a8:	19900593          	li	a1,409
ffffffffc02029ac:	00002517          	auipc	a0,0x2
ffffffffc02029b0:	4b450513          	addi	a0,a0,1204 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02029b4:	aa7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] == 0);
ffffffffc02029b8:	00003697          	auipc	a3,0x3
ffffffffc02029bc:	8e868693          	addi	a3,a3,-1816 # ffffffffc02052a0 <default_pmm_manager+0x590>
ffffffffc02029c0:	00002617          	auipc	a2,0x2
ffffffffc02029c4:	fa060613          	addi	a2,a2,-96 # ffffffffc0204960 <commands+0x818>
ffffffffc02029c8:	1b800593          	li	a1,440
ffffffffc02029cc:	00002517          	auipc	a0,0x2
ffffffffc02029d0:	49450513          	addi	a0,a0,1172 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02029d4:	a87fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc02029d8:	00003697          	auipc	a3,0x3
ffffffffc02029dc:	82868693          	addi	a3,a3,-2008 # ffffffffc0205200 <default_pmm_manager+0x4f0>
ffffffffc02029e0:	00002617          	auipc	a2,0x2
ffffffffc02029e4:	f8060613          	addi	a2,a2,-128 # ffffffffc0204960 <commands+0x818>
ffffffffc02029e8:	1a500593          	li	a1,421
ffffffffc02029ec:	00002517          	auipc	a0,0x2
ffffffffc02029f0:	47450513          	addi	a0,a0,1140 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc02029f4:	a67fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 1);
ffffffffc02029f8:	00003697          	auipc	a3,0x3
ffffffffc02029fc:	90068693          	addi	a3,a3,-1792 # ffffffffc02052f8 <default_pmm_manager+0x5e8>
ffffffffc0202a00:	00002617          	auipc	a2,0x2
ffffffffc0202a04:	f6060613          	addi	a2,a2,-160 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a08:	1bd00593          	li	a1,445
ffffffffc0202a0c:	00002517          	auipc	a0,0x2
ffffffffc0202a10:	45450513          	addi	a0,a0,1108 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a14:	a47fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202a18:	00003697          	auipc	a3,0x3
ffffffffc0202a1c:	8a068693          	addi	a3,a3,-1888 # ffffffffc02052b8 <default_pmm_manager+0x5a8>
ffffffffc0202a20:	00002617          	auipc	a2,0x2
ffffffffc0202a24:	f4060613          	addi	a2,a2,-192 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a28:	1bc00593          	li	a1,444
ffffffffc0202a2c:	00002517          	auipc	a0,0x2
ffffffffc0202a30:	43450513          	addi	a0,a0,1076 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a34:	a27fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202a38:	00002697          	auipc	a3,0x2
ffffffffc0202a3c:	75068693          	addi	a3,a3,1872 # ffffffffc0205188 <default_pmm_manager+0x478>
ffffffffc0202a40:	00002617          	auipc	a2,0x2
ffffffffc0202a44:	f2060613          	addi	a2,a2,-224 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a48:	19600593          	li	a1,406
ffffffffc0202a4c:	00002517          	auipc	a0,0x2
ffffffffc0202a50:	41450513          	addi	a0,a0,1044 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a54:	a07fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202a58:	00002697          	auipc	a3,0x2
ffffffffc0202a5c:	5d068693          	addi	a3,a3,1488 # ffffffffc0205028 <default_pmm_manager+0x318>
ffffffffc0202a60:	00002617          	auipc	a2,0x2
ffffffffc0202a64:	f0060613          	addi	a2,a2,-256 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a68:	19500593          	li	a1,405
ffffffffc0202a6c:	00002517          	auipc	a0,0x2
ffffffffc0202a70:	3f450513          	addi	a0,a0,1012 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a74:	9e7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202a78:	00002697          	auipc	a3,0x2
ffffffffc0202a7c:	72868693          	addi	a3,a3,1832 # ffffffffc02051a0 <default_pmm_manager+0x490>
ffffffffc0202a80:	00002617          	auipc	a2,0x2
ffffffffc0202a84:	ee060613          	addi	a2,a2,-288 # ffffffffc0204960 <commands+0x818>
ffffffffc0202a88:	19100593          	li	a1,401
ffffffffc0202a8c:	00002517          	auipc	a0,0x2
ffffffffc0202a90:	3d450513          	addi	a0,a0,980 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202a94:	9c7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202a98:	00002697          	auipc	a3,0x2
ffffffffc0202a9c:	57868693          	addi	a3,a3,1400 # ffffffffc0205010 <default_pmm_manager+0x300>
ffffffffc0202aa0:	00002617          	auipc	a2,0x2
ffffffffc0202aa4:	ec060613          	addi	a2,a2,-320 # ffffffffc0204960 <commands+0x818>
ffffffffc0202aa8:	19000593          	li	a1,400
ffffffffc0202aac:	00002517          	auipc	a0,0x2
ffffffffc0202ab0:	3b450513          	addi	a0,a0,948 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202ab4:	9a7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202ab8:	00002697          	auipc	a3,0x2
ffffffffc0202abc:	5f868693          	addi	a3,a3,1528 # ffffffffc02050b0 <default_pmm_manager+0x3a0>
ffffffffc0202ac0:	00002617          	auipc	a2,0x2
ffffffffc0202ac4:	ea060613          	addi	a2,a2,-352 # ffffffffc0204960 <commands+0x818>
ffffffffc0202ac8:	18f00593          	li	a1,399
ffffffffc0202acc:	00002517          	auipc	a0,0x2
ffffffffc0202ad0:	39450513          	addi	a0,a0,916 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202ad4:	987fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202ad8:	00002697          	auipc	a3,0x2
ffffffffc0202adc:	6b068693          	addi	a3,a3,1712 # ffffffffc0205188 <default_pmm_manager+0x478>
ffffffffc0202ae0:	00002617          	auipc	a2,0x2
ffffffffc0202ae4:	e8060613          	addi	a2,a2,-384 # ffffffffc0204960 <commands+0x818>
ffffffffc0202ae8:	18e00593          	li	a1,398
ffffffffc0202aec:	00002517          	auipc	a0,0x2
ffffffffc0202af0:	37450513          	addi	a0,a0,884 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202af4:	967fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202af8:	00002697          	auipc	a3,0x2
ffffffffc0202afc:	67868693          	addi	a3,a3,1656 # ffffffffc0205170 <default_pmm_manager+0x460>
ffffffffc0202b00:	00002617          	auipc	a2,0x2
ffffffffc0202b04:	e6060613          	addi	a2,a2,-416 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b08:	18d00593          	li	a1,397
ffffffffc0202b0c:	00002517          	auipc	a0,0x2
ffffffffc0202b10:	35450513          	addi	a0,a0,852 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b14:	947fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, PGSIZE, 0) == 0);
ffffffffc0202b18:	00002697          	auipc	a3,0x2
ffffffffc0202b1c:	62868693          	addi	a3,a3,1576 # ffffffffc0205140 <default_pmm_manager+0x430>
ffffffffc0202b20:	00002617          	auipc	a2,0x2
ffffffffc0202b24:	e4060613          	addi	a2,a2,-448 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b28:	18c00593          	li	a1,396
ffffffffc0202b2c:	00002517          	auipc	a0,0x2
ffffffffc0202b30:	33450513          	addi	a0,a0,820 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b34:	927fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202b38:	00002697          	auipc	a3,0x2
ffffffffc0202b3c:	5f068693          	addi	a3,a3,1520 # ffffffffc0205128 <default_pmm_manager+0x418>
ffffffffc0202b40:	00002617          	auipc	a2,0x2
ffffffffc0202b44:	e2060613          	addi	a2,a2,-480 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b48:	18900593          	li	a1,393
ffffffffc0202b4c:	00002517          	auipc	a0,0x2
ffffffffc0202b50:	31450513          	addi	a0,a0,788 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b54:	907fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] & PTE_U);
ffffffffc0202b58:	00002697          	auipc	a3,0x2
ffffffffc0202b5c:	5b068693          	addi	a3,a3,1456 # ffffffffc0205108 <default_pmm_manager+0x3f8>
ffffffffc0202b60:	00002617          	auipc	a2,0x2
ffffffffc0202b64:	e0060613          	addi	a2,a2,-512 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b68:	18800593          	li	a1,392
ffffffffc0202b6c:	00002517          	auipc	a0,0x2
ffffffffc0202b70:	2f450513          	addi	a0,a0,756 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b74:	8e7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202b78:	00002697          	auipc	a3,0x2
ffffffffc0202b7c:	58068693          	addi	a3,a3,1408 # ffffffffc02050f8 <default_pmm_manager+0x3e8>
ffffffffc0202b80:	00002617          	auipc	a2,0x2
ffffffffc0202b84:	de060613          	addi	a2,a2,-544 # ffffffffc0204960 <commands+0x818>
ffffffffc0202b88:	18700593          	li	a1,391
ffffffffc0202b8c:	00002517          	auipc	a0,0x2
ffffffffc0202b90:	2d450513          	addi	a0,a0,724 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202b94:	8c7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202b98:	00002697          	auipc	a3,0x2
ffffffffc0202b9c:	55068693          	addi	a3,a3,1360 # ffffffffc02050e8 <default_pmm_manager+0x3d8>
ffffffffc0202ba0:	00002617          	auipc	a2,0x2
ffffffffc0202ba4:	dc060613          	addi	a2,a2,-576 # ffffffffc0204960 <commands+0x818>
ffffffffc0202ba8:	18600593          	li	a1,390
ffffffffc0202bac:	00002517          	auipc	a0,0x2
ffffffffc0202bb0:	2b450513          	addi	a0,a0,692 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202bb4:	8a7fd0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("DTB memory info not available");
ffffffffc0202bb8:	00002617          	auipc	a2,0x2
ffffffffc0202bbc:	2d060613          	addi	a2,a2,720 # ffffffffc0204e88 <default_pmm_manager+0x178>
ffffffffc0202bc0:	06500593          	li	a1,101
ffffffffc0202bc4:	00002517          	auipc	a0,0x2
ffffffffc0202bc8:	29c50513          	addi	a0,a0,668 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202bcc:	88ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc0202bd0:	00002697          	auipc	a3,0x2
ffffffffc0202bd4:	63068693          	addi	a3,a3,1584 # ffffffffc0205200 <default_pmm_manager+0x4f0>
ffffffffc0202bd8:	00002617          	auipc	a2,0x2
ffffffffc0202bdc:	d8860613          	addi	a2,a2,-632 # ffffffffc0204960 <commands+0x818>
ffffffffc0202be0:	1cf00593          	li	a1,463
ffffffffc0202be4:	00002517          	auipc	a0,0x2
ffffffffc0202be8:	27c50513          	addi	a0,a0,636 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202bec:	86ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202bf0:	00002697          	auipc	a3,0x2
ffffffffc0202bf4:	4c068693          	addi	a3,a3,1216 # ffffffffc02050b0 <default_pmm_manager+0x3a0>
ffffffffc0202bf8:	00002617          	auipc	a2,0x2
ffffffffc0202bfc:	d6860613          	addi	a2,a2,-664 # ffffffffc0204960 <commands+0x818>
ffffffffc0202c00:	18500593          	li	a1,389
ffffffffc0202c04:	00002517          	auipc	a0,0x2
ffffffffc0202c08:	25c50513          	addi	a0,a0,604 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202c0c:	84ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202c10:	00002697          	auipc	a3,0x2
ffffffffc0202c14:	46068693          	addi	a3,a3,1120 # ffffffffc0205070 <default_pmm_manager+0x360>
ffffffffc0202c18:	00002617          	auipc	a2,0x2
ffffffffc0202c1c:	d4860613          	addi	a2,a2,-696 # ffffffffc0204960 <commands+0x818>
ffffffffc0202c20:	18400593          	li	a1,388
ffffffffc0202c24:	00002517          	auipc	a0,0x2
ffffffffc0202c28:	23c50513          	addi	a0,a0,572 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0202c36:	11660613          	addi	a2,a2,278 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0202c3a:	17d00593          	li	a1,381
ffffffffc0202c3e:	00002517          	auipc	a0,0x2
ffffffffc0202c42:	22250513          	addi	a0,a0,546 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202c46:	815fd0ef          	jal	ra,ffffffffc020045a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir_va[0]));
ffffffffc0202c4a:	00002617          	auipc	a2,0x2
ffffffffc0202c4e:	0fe60613          	addi	a2,a2,254 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc0202c52:	17c00593          	li	a1,380
ffffffffc0202c56:	00002517          	auipc	a0,0x2
ffffffffc0202c5a:	20a50513          	addi	a0,a0,522 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202c5e:	ffcfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);//referred?
ffffffffc0202c62:	00002697          	auipc	a3,0x2
ffffffffc0202c66:	3c668693          	addi	a3,a3,966 # ffffffffc0205028 <default_pmm_manager+0x318>
ffffffffc0202c6a:	00002617          	auipc	a2,0x2
ffffffffc0202c6e:	cf660613          	addi	a2,a2,-778 # ffffffffc0204960 <commands+0x818>
ffffffffc0202c72:	17a00593          	li	a1,378
ffffffffc0202c76:	00002517          	auipc	a0,0x2
ffffffffc0202c7a:	1ea50513          	addi	a0,a0,490 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202c7e:	fdcfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);//right ptr?检验pte是否有效
ffffffffc0202c82:	00002697          	auipc	a3,0x2
ffffffffc0202c86:	38e68693          	addi	a3,a3,910 # ffffffffc0205010 <default_pmm_manager+0x300>
ffffffffc0202c8a:	00002617          	auipc	a2,0x2
ffffffffc0202c8e:	cd660613          	addi	a2,a2,-810 # ffffffffc0204960 <commands+0x818>
ffffffffc0202c92:	17900593          	li	a1,377
ffffffffc0202c96:	00002517          	auipc	a0,0x2
ffffffffc0202c9a:	1ca50513          	addi	a0,a0,458 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202c9e:	fbcfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202ca2:	00002697          	auipc	a3,0x2
ffffffffc0202ca6:	71e68693          	addi	a3,a3,1822 # ffffffffc02053c0 <default_pmm_manager+0x6b0>
ffffffffc0202caa:	00002617          	auipc	a2,0x2
ffffffffc0202cae:	cb660613          	addi	a2,a2,-842 # ffffffffc0204960 <commands+0x818>
ffffffffc0202cb2:	1c600593          	li	a1,454
ffffffffc0202cb6:	00002517          	auipc	a0,0x2
ffffffffc0202cba:	1aa50513          	addi	a0,a0,426 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202cbe:	f9cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202cc2:	00002697          	auipc	a3,0x2
ffffffffc0202cc6:	6c668693          	addi	a3,a3,1734 # ffffffffc0205388 <default_pmm_manager+0x678>
ffffffffc0202cca:	00002617          	auipc	a2,0x2
ffffffffc0202cce:	c9660613          	addi	a2,a2,-874 # ffffffffc0204960 <commands+0x818>
ffffffffc0202cd2:	1c300593          	li	a1,451
ffffffffc0202cd6:	00002517          	auipc	a0,0x2
ffffffffc0202cda:	18a50513          	addi	a0,a0,394 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202cde:	f7cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202ce2:	00002697          	auipc	a3,0x2
ffffffffc0202ce6:	67668693          	addi	a3,a3,1654 # ffffffffc0205358 <default_pmm_manager+0x648>
ffffffffc0202cea:	00002617          	auipc	a2,0x2
ffffffffc0202cee:	c7660613          	addi	a2,a2,-906 # ffffffffc0204960 <commands+0x818>
ffffffffc0202cf2:	1bf00593          	li	a1,447
ffffffffc0202cf6:	00002517          	auipc	a0,0x2
ffffffffc0202cfa:	16a50513          	addi	a0,a0,362 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202cfe:	f5cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202d02:	00002697          	auipc	a3,0x2
ffffffffc0202d06:	60e68693          	addi	a3,a3,1550 # ffffffffc0205310 <default_pmm_manager+0x600>
ffffffffc0202d0a:	00002617          	auipc	a2,0x2
ffffffffc0202d0e:	c5660613          	addi	a2,a2,-938 # ffffffffc0204960 <commands+0x818>
ffffffffc0202d12:	1be00593          	li	a1,446
ffffffffc0202d16:	00002517          	auipc	a0,0x2
ffffffffc0202d1a:	14a50513          	addi	a0,a0,330 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202d1e:	f3cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    boot_pgdir_pa = PADDR(boot_pgdir_va);
ffffffffc0202d22:	00002617          	auipc	a2,0x2
ffffffffc0202d26:	0ce60613          	addi	a2,a2,206 # ffffffffc0204df0 <default_pmm_manager+0xe0>
ffffffffc0202d2a:	0cc00593          	li	a1,204
ffffffffc0202d2e:	00002517          	auipc	a0,0x2
ffffffffc0202d32:	13250513          	addi	a0,a0,306 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202d36:	f24fd0ef          	jal	ra,ffffffffc020045a <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0202d3a:	00002617          	auipc	a2,0x2
ffffffffc0202d3e:	0b660613          	addi	a2,a2,182 # ffffffffc0204df0 <default_pmm_manager+0xe0>
ffffffffc0202d42:	08100593          	li	a1,129
ffffffffc0202d46:	00002517          	auipc	a0,0x2
ffffffffc0202d4a:	11a50513          	addi	a0,a0,282 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202d4e:	f0cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, 0x0, 0)) != NULL);
ffffffffc0202d52:	00002697          	auipc	a3,0x2
ffffffffc0202d56:	28e68693          	addi	a3,a3,654 # ffffffffc0204fe0 <default_pmm_manager+0x2d0>
ffffffffc0202d5a:	00002617          	auipc	a2,0x2
ffffffffc0202d5e:	c0660613          	addi	a2,a2,-1018 # ffffffffc0204960 <commands+0x818>
ffffffffc0202d62:	17800593          	li	a1,376
ffffffffc0202d66:	00002517          	auipc	a0,0x2
ffffffffc0202d6a:	0fa50513          	addi	a0,a0,250 # ffffffffc0204e60 <default_pmm_manager+0x150>
ffffffffc0202d6e:	eecfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, 0x0, 0) == 0);////把这个物理页面通过多级页表映射到0x0
ffffffffc0202d72:	00002697          	auipc	a3,0x2
ffffffffc0202d76:	23e68693          	addi	a3,a3,574 # ffffffffc0204fb0 <default_pmm_manager+0x2a0>
ffffffffc0202d7a:	00002617          	auipc	a2,0x2
ffffffffc0202d7e:	be660613          	addi	a2,a2,-1050 # ffffffffc0204960 <commands+0x818>
ffffffffc0202d82:	17500593          	li	a1,373
ffffffffc0202d86:	00002517          	auipc	a0,0x2
ffffffffc0202d8a:	0da50513          	addi	a0,a0,218 # ffffffffc0204e60 <default_pmm_manager+0x150>
...
ffffffffc0202d98:	67468693          	addi	a3,a3,1652 # ffffffffc0205408 <default_pmm_manager+0x6f8>
ffffffffc0202d9c:	00002617          	auipc	a2,0x2
ffffffffc0202da0:	bc460613          	addi	a2,a2,-1084 # ffffffffc0204960 <commands+0x818>
ffffffffc0202da4:	08800593          	li	a1,136
ffffffffc0202da8:	00002517          	auipc	a0,0x2
ffffffffc0202dac:	68050513          	addi	a0,a0,1664 # ffffffffc0205428 <default_pmm_manager+0x718>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next)
...
ffffffffc0202e6a:	5d268693          	addi	a3,a3,1490 # ffffffffc0205438 <default_pmm_manager+0x728>
ffffffffc0202e6e:	00002617          	auipc	a2,0x2
ffffffffc0202e72:	af260613          	addi	a2,a2,-1294 # ffffffffc0204960 <commands+0x818>
ffffffffc0202e76:	08e00593          	li	a1,142
ffffffffc0202e7a:	00002517          	auipc	a0,0x2
ffffffffc0202e7e:	5ae50513          	addi	a0,a0,1454 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0202e82:	dd8fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0202e86:	00002697          	auipc	a3,0x2
ffffffffc0202e8a:	5f268693          	addi	a3,a3,1522 # ffffffffc0205478 <default_pmm_manager+0x768>
ffffffffc0202e8e:	00002617          	auipc	a2,0x2
ffffffffc0202e92:	ad260613          	addi	a2,a2,-1326 # ffffffffc0204960 <commands+0x818>
ffffffffc0202e96:	08700593          	li	a1,135
ffffffffc0202e9a:	00002517          	auipc	a0,0x2
ffffffffc0202e9e:	58e50513          	addi	a0,a0,1422 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0202ea2:	db8fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0202ea6:	00002697          	auipc	a3,0x2
ffffffffc0202eaa:	5b268693          	addi	a3,a3,1458 # ffffffffc0205458 <default_pmm_manager+0x748>
ffffffffc0202eae:	00002617          	auipc	a2,0x2
ffffffffc0202eb2:	ab260613          	addi	a2,a2,-1358 # ffffffffc0204960 <commands+0x818>
ffffffffc0202eb6:	08600593          	li	a1,134
ffffffffc0202eba:	00002517          	auipc	a0,0x2
ffffffffc0202ebe:	56e50513          	addi	a0,a0,1390 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc0202f24:	6f068693          	addi	a3,a3,1776 # ffffffffc0205610 <default_pmm_manager+0x900>
ffffffffc0202f28:	00002617          	auipc	a2,0x2
ffffffffc0202f2c:	a3860613          	addi	a2,a2,-1480 # ffffffffc0204960 <commands+0x818>
ffffffffc0202f30:	0da00593          	li	a1,218
ffffffffc0202f34:	00002517          	auipc	a0,0x2
ffffffffc0202f38:	4f450513          	addi	a0,a0,1268 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc0202f72:	6a268693          	addi	a3,a3,1698 # ffffffffc0205610 <default_pmm_manager+0x900>
ffffffffc0202f76:	00002617          	auipc	a2,0x2
ffffffffc0202f7a:	9ea60613          	addi	a2,a2,-1558 # ffffffffc0204960 <commands+0x818>
ffffffffc0202f7e:	0e100593          	li	a1,225
ffffffffc0202f82:	00002517          	auipc	a0,0x2
ffffffffc0202f86:	4a650513          	addi	a0,a0,1190 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc0203046:	55650513          	addi	a0,a0,1366 # ffffffffc0205598 <default_pmm_manager+0x888>
ffffffffc020304a:	94afd0ef          	jal	ra,ffffffffc0200194 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020304e:	00002697          	auipc	a3,0x2
ffffffffc0203052:	57268693          	addi	a3,a3,1394 # ffffffffc02055c0 <default_pmm_manager+0x8b0>
ffffffffc0203056:	00002617          	auipc	a2,0x2
ffffffffc020305a:	90a60613          	addi	a2,a2,-1782 # ffffffffc0204960 <commands+0x818>
ffffffffc020305e:	10700593          	li	a1,263
ffffffffc0203062:	00002517          	auipc	a0,0x2
ffffffffc0203066:	3c650513          	addi	a0,a0,966 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc0203098:	54450513          	addi	a0,a0,1348 # ffffffffc02055d8 <default_pmm_manager+0x8c8>
...
ffffffffc02030b2:	54a50513          	addi	a0,a0,1354 # ffffffffc02055f8 <default_pmm_manager+0x8e8>
}
...
ffffffffc02030c0:	3f468693          	addi	a3,a3,1012 # ffffffffc02054b0 <default_pmm_manager+0x7a0>
ffffffffc02030c4:	00002617          	auipc	a2,0x2
ffffffffc02030c8:	89c60613          	addi	a2,a2,-1892 # ffffffffc0204960 <commands+0x818>
ffffffffc02030cc:	0eb00593          	li	a1,235
ffffffffc02030d0:	00002517          	auipc	a0,0x2
ffffffffc02030d4:	35850513          	addi	a0,a0,856 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc02030d8:	b82fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc02030dc:	00002697          	auipc	a3,0x2
ffffffffc02030e0:	45c68693          	addi	a3,a3,1116 # ffffffffc0205538 <default_pmm_manager+0x828>
ffffffffc02030e4:	00002617          	auipc	a2,0x2
ffffffffc02030e8:	87c60613          	addi	a2,a2,-1924 # ffffffffc0204960 <commands+0x818>
ffffffffc02030ec:	0fc00593          	li	a1,252
ffffffffc02030f0:	00002517          	auipc	a0,0x2
ffffffffc02030f4:	33850513          	addi	a0,a0,824 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc02030f8:	b62fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc02030fc:	00002697          	auipc	a3,0x2
ffffffffc0203100:	46c68693          	addi	a3,a3,1132 # ffffffffc0205568 <default_pmm_manager+0x858>
ffffffffc0203104:	00002617          	auipc	a2,0x2
ffffffffc0203108:	85c60613          	addi	a2,a2,-1956 # ffffffffc0204960 <commands+0x818>
ffffffffc020310c:	0fd00593          	li	a1,253
ffffffffc0203110:	00002517          	auipc	a0,0x2
ffffffffc0203114:	31850513          	addi	a0,a0,792 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203118:	b42fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc020311c:	00002697          	auipc	a3,0x2
ffffffffc0203120:	37c68693          	addi	a3,a3,892 # ffffffffc0205498 <default_pmm_manager+0x788>
ffffffffc0203124:	00002617          	auipc	a2,0x2
ffffffffc0203128:	83c60613          	addi	a2,a2,-1988 # ffffffffc0204960 <commands+0x818>
ffffffffc020312c:	0e900593          	li	a1,233
ffffffffc0203130:	00002517          	auipc	a0,0x2
ffffffffc0203134:	2f850513          	addi	a0,a0,760 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203138:	b22fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2 != NULL);
ffffffffc020313c:	00002697          	auipc	a3,0x2
ffffffffc0203140:	3bc68693          	addi	a3,a3,956 # ffffffffc02054f8 <default_pmm_manager+0x7e8>
ffffffffc0203144:	00002617          	auipc	a2,0x2
ffffffffc0203148:	81c60613          	addi	a2,a2,-2020 # ffffffffc0204960 <commands+0x818>
ffffffffc020314c:	0f400593          	li	a1,244
ffffffffc0203150:	00002517          	auipc	a0,0x2
ffffffffc0203154:	2d850513          	addi	a0,a0,728 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203158:	b02fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1 != NULL);
ffffffffc020315c:	00002697          	auipc	a3,0x2
ffffffffc0203160:	38c68693          	addi	a3,a3,908 # ffffffffc02054e8 <default_pmm_manager+0x7d8>
ffffffffc0203164:	00001617          	auipc	a2,0x1
ffffffffc0203168:	7fc60613          	addi	a2,a2,2044 # ffffffffc0204960 <commands+0x818>
ffffffffc020316c:	0f200593          	li	a1,242
ffffffffc0203170:	00002517          	auipc	a0,0x2
ffffffffc0203174:	2b850513          	addi	a0,a0,696 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203178:	ae2fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma3 == NULL);
ffffffffc020317c:	00002697          	auipc	a3,0x2
ffffffffc0203180:	38c68693          	addi	a3,a3,908 # ffffffffc0205508 <default_pmm_manager+0x7f8>
ffffffffc0203184:	00001617          	auipc	a2,0x1
ffffffffc0203188:	7dc60613          	addi	a2,a2,2012 # ffffffffc0204960 <commands+0x818>
ffffffffc020318c:	0f600593          	li	a1,246
ffffffffc0203190:	00002517          	auipc	a0,0x2
ffffffffc0203194:	29850513          	addi	a0,a0,664 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc0203198:	ac2fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma5 == NULL);
ffffffffc020319c:	00002697          	auipc	a3,0x2
ffffffffc02031a0:	38c68693          	addi	a3,a3,908 # ffffffffc0205528 <default_pmm_manager+0x818>
ffffffffc02031a4:	00001617          	auipc	a2,0x1
ffffffffc02031a8:	7bc60613          	addi	a2,a2,1980 # ffffffffc0204960 <commands+0x818>
ffffffffc02031ac:	0fa00593          	li	a1,250
ffffffffc02031b0:	00002517          	auipc	a0,0x2
ffffffffc02031b4:	27850513          	addi	a0,a0,632 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc02031b8:	aa2fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma4 == NULL);
ffffffffc02031bc:	00002697          	auipc	a3,0x2
ffffffffc02031c0:	35c68693          	addi	a3,a3,860 # ffffffffc0205518 <default_pmm_manager+0x808>
ffffffffc02031c4:	00001617          	auipc	a2,0x1
ffffffffc02031c8:	79c60613          	addi	a2,a2,1948 # ffffffffc0204960 <commands+0x818>
ffffffffc02031cc:	0f800593          	li	a1,248
ffffffffc02031d0:	00002517          	auipc	a0,0x2
ffffffffc02031d4:	25850513          	addi	a0,a0,600 # ffffffffc0205428 <default_pmm_manager+0x718>
ffffffffc02031d8:	a82fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(mm != NULL);
ffffffffc02031dc:	00002697          	auipc	a3,0x2
ffffffffc02031e0:	44468693          	addi	a3,a3,1092 # ffffffffc0205620 <default_pmm_manager+0x910>
ffffffffc02031e4:	00001617          	auipc	a2,0x1
ffffffffc02031e8:	77c60613          	addi	a2,a2,1916 # ffffffffc0204960 <commands+0x818>
ffffffffc02031ec:	0d200593          	li	a1,210
ffffffffc02031f0:	00002517          	auipc	a0,0x2
ffffffffc02031f4:	23850513          	addi	a0,a0,568 # ffffffffc0205428 <default_pmm_manager+0x718>
...
ffffffffc02031fe:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0203200:	432000ef          	jal	ra,ffffffffc0203632 <do_exit>

ffffffffc0203204 <alloc_proc>:
...
alloc_proc(void)
{
ffffffffc0203204:	1141                	addi	sp,sp,-16
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0203206:	0e800513          	li	a0,232
{
ffffffffc020320a:	e022                	sd	s0,0(sp)
ffffffffc020320c:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc020320e:	8a1fe0ef          	jal	ra,ffffffffc0201aae <kmalloc>
ffffffffc0203212:	842a                	mv	s0,a0
    if (proc != NULL)
ffffffffc0203214:	c521                	beqz	a0,ffffffffc020325c <alloc_proc+0x58>
        // 初始化进程状态为未初始化
...
ffffffffc0203216:	0000a797          	auipc	a5,0xa
ffffffffc020321a:	28a7b783          	ld	a5,650(a5) # ffffffffc020d4a0 <boot_pgdir_pa>
ffffffffc020321e:	f55c                	sd	a5,168(a0)
        proc->state = PROC_UNINIT;
ffffffffc0203220:	57fd                	li	a5,-1
ffffffffc0203222:	1782                	slli	a5,a5,0x20
        // 初始化父进程指针为NULL
        proc->parent = NULL;
        // 初始化内存管理结构为NULL
        proc->mm = NULL;
...
ffffffffc020322a:	e11c                	sd	a5,0(a0)
        proc->runs = 0;
ffffffffc020322c:	00052423          	sw	zero,8(a0)
        proc->kstack = 0;
ffffffffc0203230:	00053823          	sd	zero,16(a0)
        proc->need_resched = 0;
ffffffffc0203234:	00052c23          	sw	zero,24(a0)
        proc->parent = NULL;
ffffffffc0203238:	02053023          	sd	zero,32(a0)
        proc->mm = NULL;
ffffffffc020323c:	02053423          	sd	zero,40(a0)
        memset(&(proc->context), 0, sizeof(struct context));
ffffffffc0203240:	03050513          	addi	a0,a0,48
ffffffffc0203244:	44b000ef          	jal	ra,ffffffffc0203e8e <memset>
        // 初始化陷阱帧指针为NULL
        proc->tf = NULL;
        // 初始化进程标志为0
        proc->flags = 0;
...
ffffffffc0203248:	4641                	li	a2,16
        proc->tf = NULL;
ffffffffc020324a:	0a043023          	sd	zero,160(s0)
        proc->flags = 0;
ffffffffc020324e:	0a042823          	sw	zero,176(s0)
        memset(proc->name, 0, PROC_NAME_LEN + 1);
ffffffffc0203252:	4581                	li	a1,0
ffffffffc0203254:	0b440513          	addi	a0,s0,180
ffffffffc0203258:	437000ef          	jal	ra,ffffffffc0203e8e <memset>
    }
    return proc;
}
ffffffffc020325c:	60a2                	ld	ra,8(sp)
ffffffffc020325e:	8522                	mv	a0,s0
ffffffffc0203260:	6402                	ld	s0,0(sp)
ffffffffc0203262:	0141                	addi	sp,sp,16
ffffffffc0203264:	8082                	ret

ffffffffc0203266 <forkret>:
...
ffffffffc020326a:	26a7b783          	ld	a5,618(a5) # ffffffffc020d4d0 <current>
ffffffffc020326e:	73c8                	ld	a0,160(a5)
ffffffffc0203270:	b5dfd06f          	j	ffffffffc0200dcc <forkrets>

ffffffffc0203274 <init_main>:
}
...
init_main(void *arg)
{
ffffffffc0203274:	7179                	addi	sp,sp,-48
ffffffffc0203276:	ec26                	sd	s1,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc0203278:	0000a497          	auipc	s1,0xa
ffffffffc020327c:	1d048493          	addi	s1,s1,464 # ffffffffc020d448 <name.2>
{
ffffffffc0203280:	f022                	sd	s0,32(sp)
ffffffffc0203282:	e84a                	sd	s2,16(sp)
ffffffffc0203284:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0203286:	0000a917          	auipc	s2,0xa
ffffffffc020328a:	24a93903          	ld	s2,586(s2) # ffffffffc020d4d0 <current>
    memset(name, 0, sizeof(name));
ffffffffc020328e:	4641                	li	a2,16
ffffffffc0203290:	4581                	li	a1,0
ffffffffc0203292:	8526                	mv	a0,s1
{
ffffffffc0203294:	f406                	sd	ra,40(sp)
ffffffffc0203296:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0203298:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc020329c:	3f3000ef          	jal	ra,ffffffffc0203e8e <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02032a0:	0b490593          	addi	a1,s2,180
ffffffffc02032a4:	463d                	li	a2,15
ffffffffc02032a6:	8526                	mv	a0,s1
ffffffffc02032a8:	3f9000ef          	jal	ra,ffffffffc0203ea0 <memcpy>
ffffffffc02032ac:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02032ae:	85ce                	mv	a1,s3
ffffffffc02032b0:	00002517          	auipc	a0,0x2
ffffffffc02032b4:	38050513          	addi	a0,a0,896 # ffffffffc0205630 <default_pmm_manager+0x920>
ffffffffc02032b8:	eddfc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc02032bc:	85a2                	mv	a1,s0
ffffffffc02032be:	00002517          	auipc	a0,0x2
ffffffffc02032c2:	39a50513          	addi	a0,a0,922 # ffffffffc0205658 <default_pmm_manager+0x948>
ffffffffc02032c6:	ecffc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02032ca:	00002517          	auipc	a0,0x2
ffffffffc02032ce:	39e50513          	addi	a0,a0,926 # ffffffffc0205668 <default_pmm_manager+0x958>
ffffffffc02032d2:	ec3fc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    return 0;
}
ffffffffc02032d6:	70a2                	ld	ra,40(sp)
ffffffffc02032d8:	7402                	ld	s0,32(sp)
ffffffffc02032da:	64e2                	ld	s1,24(sp)
ffffffffc02032dc:	6942                	ld	s2,16(sp)
ffffffffc02032de:	69a2                	ld	s3,8(sp)
ffffffffc02032e0:	4501                	li	a0,0
ffffffffc02032e2:	6145                	addi	sp,sp,48
ffffffffc02032e4:	8082                	ret

ffffffffc02032e6 <proc_run>:
{
ffffffffc02032e6:	7179                	addi	sp,sp,-48
ffffffffc02032e8:	ec4a                	sd	s2,24(sp)
    if (proc != current)
ffffffffc02032ea:	0000a917          	auipc	s2,0xa
ffffffffc02032ee:	1e690913          	addi	s2,s2,486 # ffffffffc020d4d0 <current>
{
ffffffffc02032f2:	f026                	sd	s1,32(sp)
    if (proc != current)
ffffffffc02032f4:	00093483          	ld	s1,0(s2)
{
ffffffffc02032f8:	f406                	sd	ra,40(sp)
ffffffffc02032fa:	e84e                	sd	s3,16(sp)
    if (proc != current)
ffffffffc02032fc:	02a48a63          	beq	s1,a0,ffffffffc0203330 <proc_run+0x4a>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203300:	100027f3          	csrr	a5,sstatus
ffffffffc0203304:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0203306:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203308:	e7b1                	bnez	a5,ffffffffc0203354 <proc_run+0x6e>
        if (proc->pgdir != 0) {// 不是内核进程，则加载页目录
ffffffffc020330a:	755c                	ld	a5,168(a0)
        current = proc;
ffffffffc020330c:	00a93023          	sd	a0,0(s2)
        if (proc->pgdir != 0) {// 不是内核进程，则加载页目录
ffffffffc0203310:	c795                	beqz	a5,ffffffffc020333c <proc_run+0x56>
...
ffffffffc0203312:	80000737          	lui	a4,0x80000
ffffffffc0203316:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc020331a:	8fd9                	or	a5,a5,a4
...
ffffffffc0203324:	03048513          	addi	a0,s1,48
ffffffffc0203328:	590000ef          	jal	ra,ffffffffc02038b8 <switch_to>
    if (flag) {
ffffffffc020332c:	00099d63          	bnez	s3,ffffffffc0203346 <proc_run+0x60>
}
ffffffffc0203330:	70a2                	ld	ra,40(sp)
ffffffffc0203332:	7482                	ld	s1,32(sp)
ffffffffc0203334:	6962                	ld	s2,24(sp)
ffffffffc0203336:	69c2                	ld	s3,16(sp)
ffffffffc0203338:	6145                	addi	sp,sp,48
ffffffffc020333a:	8082                	ret
            lsatp(boot_pgdir_pa);  // pgdir of kernel t
ffffffffc020333c:	0000a797          	auipc	a5,0xa
ffffffffc0203340:	1647b783          	ld	a5,356(a5) # ffffffffc020d4a0 <boot_pgdir_pa>
ffffffffc0203344:	b7f9                	j	ffffffffc0203312 <proc_run+0x2c>
}
...
ffffffffc020334e:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0203350:	ddafd06f          	j	ffffffffc020092a <intr_enable>
ffffffffc0203354:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0203356:	ddafd0ef          	jal	ra,ffffffffc0200930 <intr_disable>
        return 1;
ffffffffc020335a:	6522                	ld	a0,8(sp)
ffffffffc020335c:	4985                	li	s3,1
ffffffffc020335e:	b775                	j	ffffffffc020330a <proc_run+0x24>

ffffffffc0203360 <do_fork>:
{
ffffffffc0203360:	7179                	addi	sp,sp,-48
ffffffffc0203362:	ec26                	sd	s1,24(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc0203364:	0000a497          	auipc	s1,0xa
ffffffffc0203368:	18448493          	addi	s1,s1,388 # ffffffffc020d4e8 <nr_process>
ffffffffc020336c:	4098                	lw	a4,0(s1)
{
ffffffffc020336e:	f406                	sd	ra,40(sp)
ffffffffc0203370:	f022                	sd	s0,32(sp)
ffffffffc0203372:	e84a                	sd	s2,16(sp)
ffffffffc0203374:	e44e                	sd	s3,8(sp)
ffffffffc0203376:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc0203378:	6785                	lui	a5,0x1
ffffffffc020337a:	22f75163          	bge	a4,a5,ffffffffc020359c <do_fork+0x23c>
ffffffffc020337e:	892e                	mv	s2,a1
ffffffffc0203380:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) {
ffffffffc0203382:	e83ff0ef          	jal	ra,ffffffffc0203204 <alloc_proc>
ffffffffc0203386:	89aa                	mv	s3,a0
ffffffffc0203388:	20050f63          	beqz	a0,ffffffffc02035a6 <do_fork+0x246>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020338c:	4509                	li	a0,2
ffffffffc020338e:	8fffe0ef          	jal	ra,ffffffffc0201c8c <alloc_pages>
    if (page != NULL)
ffffffffc0203392:	20050063          	beqz	a0,ffffffffc0203592 <do_fork+0x232>
    return page - pages + nbase;
ffffffffc0203396:	0000a697          	auipc	a3,0xa
ffffffffc020339a:	1226b683          	ld	a3,290(a3) # ffffffffc020d4b8 <pages>
ffffffffc020339e:	40d506b3          	sub	a3,a0,a3
ffffffffc02033a2:	8699                	srai	a3,a3,0x6
ffffffffc02033a4:	00002517          	auipc	a0,0x2
ffffffffc02033a8:	68453503          	ld	a0,1668(a0) # ffffffffc0205a28 <nbase>
ffffffffc02033ac:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02033ae:	00c69793          	slli	a5,a3,0xc
ffffffffc02033b2:	83b1                	srli	a5,a5,0xc
ffffffffc02033b4:	0000a717          	auipc	a4,0xa
ffffffffc02033b8:	0fc73703          	ld	a4,252(a4) # ffffffffc020d4b0 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02033bc:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02033be:	20e7f663          	bgeu	a5,a4,ffffffffc02035ca <do_fork+0x26a>
    assert(current->mm == NULL);
ffffffffc02033c2:	0000aa17          	auipc	s4,0xa
ffffffffc02033c6:	10ea0a13          	addi	s4,s4,270 # ffffffffc020d4d0 <current>
ffffffffc02033ca:	000a3303          	ld	t1,0(s4)
ffffffffc02033ce:	0000a797          	auipc	a5,0xa
ffffffffc02033d2:	0fa7b783          	ld	a5,250(a5) # ffffffffc020d4c8 <va_pa_offset>
ffffffffc02033d6:	96be                	add	a3,a3,a5
ffffffffc02033d8:	02833783          	ld	a5,40(t1)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02033dc:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02033e0:	1c079563          	bnez	a5,ffffffffc02035aa <do_fork+0x24a>
...
ffffffffc02033ec:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02033ee:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc02033f2:	87b6                	mv	a5,a3
ffffffffc02033f4:	12040893          	addi	a7,s0,288
ffffffffc02033f8:	00063803          	ld	a6,0(a2)
ffffffffc02033fc:	6608                	ld	a0,8(a2)
ffffffffc02033fe:	6a0c                	ld	a1,16(a2)
ffffffffc0203400:	6e18                	ld	a4,24(a2)
ffffffffc0203402:	0107b023          	sd	a6,0(a5)
ffffffffc0203406:	e788                	sd	a0,8(a5)
ffffffffc0203408:	eb8c                	sd	a1,16(a5)
ffffffffc020340a:	ef98                	sd	a4,24(a5)
ffffffffc020340c:	02060613          	addi	a2,a2,32
ffffffffc0203410:	02078793          	addi	a5,a5,32
ffffffffc0203414:	ff1612e3          	bne	a2,a7,ffffffffc02033f8 <do_fork+0x98>
    proc->tf->gpr.a0 = 0;
ffffffffc0203418:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020341c:	12090763          	beqz	s2,ffffffffc020354a <do_fork+0x1ea>
ffffffffc0203420:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;//simulating as if twas returned from a trap handle
ffffffffc0203424:	00000797          	auipc	a5,0x0
ffffffffc0203428:	e4278793          	addi	a5,a5,-446 # ffffffffc0203266 <forkret>
ffffffffc020342c:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0203430:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc020343a:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020343c:	12079863          	bnez	a5,ffffffffc020356c <do_fork+0x20c>
    if (++last_pid >= MAX_PID)
ffffffffc0203440:	00006817          	auipc	a6,0x6
ffffffffc0203444:	be880813          	addi	a6,a6,-1048 # ffffffffc0209028 <last_pid.1>
ffffffffc0203448:	00082783          	lw	a5,0(a6)
ffffffffc020344c:	6709                	lui	a4,0x2
ffffffffc020344e:	0017851b          	addiw	a0,a5,1
ffffffffc0203452:	00a82023          	sw	a0,0(a6)
ffffffffc0203456:	08e55363          	bge	a0,a4,ffffffffc02034dc <do_fork+0x17c>
    if (last_pid >= next_safe)
ffffffffc020345a:	00006e17          	auipc	t3,0x6
ffffffffc020345e:	bd2e0e13          	addi	t3,t3,-1070 # ffffffffc020902c <next_safe.0>
ffffffffc0203462:	000e2783          	lw	a5,0(t3)
ffffffffc0203466:	0000a417          	auipc	s0,0xa
ffffffffc020346a:	ff240413          	addi	s0,s0,-14 # ffffffffc020d458 <proc_list>
ffffffffc020346e:	06f55f63          	bge	a0,a5,ffffffffc02034ec <do_fork+0x18c>
    proc->pid = get_pid();
ffffffffc0203472:	00a9a223          	sw	a0,4(s3)
    proc->parent = current;
ffffffffc0203476:	0269b023          	sd	t1,32(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020347a:	45a9                	li	a1,10
ffffffffc020347c:	2501                	sext.w	a0,a0
ffffffffc020347e:	56a000ef          	jal	ra,ffffffffc02039e8 <hash32>
...
ffffffffc02034bc:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02034be:	0a091d63          	bnez	s2,ffffffffc0203578 <do_fork+0x218>
    wakeup_proc(proc);
ffffffffc02034c2:	854e                	mv	a0,s3
ffffffffc02034c4:	45e000ef          	jal	ra,ffffffffc0203922 <wakeup_proc>
    ret = proc->pid;
...
ffffffffc02034d6:	6a02                	ld	s4,0(sp)
...
ffffffffc02034e4:	00006e17          	auipc	t3,0x6
ffffffffc02034e8:	b48e0e13          	addi	t3,t3,-1208 # ffffffffc020902c <next_safe.0>
    return listelm->next;
ffffffffc02034ec:	0000a417          	auipc	s0,0xa
ffffffffc02034f0:	f6c40413          	addi	s0,s0,-148 # ffffffffc020d458 <proc_list>
ffffffffc02034f4:	00843e83          	ld	t4,8(s0)
        next_safe = MAX_PID;
ffffffffc02034f8:	6789                	lui	a5,0x2
ffffffffc02034fa:	00fe2023          	sw	a5,0(t3)
ffffffffc02034fe:	86aa                	mv	a3,a0
ffffffffc0203500:	4581                	li	a1,0
        while ((le = list_next(le)) != list)
ffffffffc0203502:	6f09                	lui	t5,0x2
ffffffffc0203504:	088e8263          	beq	t4,s0,ffffffffc0203588 <do_fork+0x228>
ffffffffc0203508:	88ae                	mv	a7,a1
ffffffffc020350a:	87f6                	mv	a5,t4
ffffffffc020350c:	6609                	lui	a2,0x2
ffffffffc020350e:	a811                	j	ffffffffc0203522 <do_fork+0x1c2>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc0203510:	00e6d663          	bge	a3,a4,ffffffffc020351c <do_fork+0x1bc>
ffffffffc0203514:	00c75463          	bge	a4,a2,ffffffffc020351c <do_fork+0x1bc>
ffffffffc0203518:	863a                	mv	a2,a4
ffffffffc020351a:	4885                	li	a7,1
ffffffffc020351c:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc020351e:	00878d63          	beq	a5,s0,ffffffffc0203538 <do_fork+0x1d8>
            if (proc->pid == last_pid)
ffffffffc0203522:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0203526:	fed715e3          	bne	a4,a3,ffffffffc0203510 <do_fork+0x1b0>
                if (++last_pid >= next_safe)
ffffffffc020352a:	2685                	addiw	a3,a3,1
ffffffffc020352c:	04c6d963          	bge	a3,a2,ffffffffc020357e <do_fork+0x21e>
ffffffffc0203530:	679c                	ld	a5,8(a5)
ffffffffc0203532:	4585                	li	a1,1
        while ((le = list_next(le)) != list)
ffffffffc0203534:	fe8797e3          	bne	a5,s0,ffffffffc0203522 <do_fork+0x1c2>
ffffffffc0203538:	c581                	beqz	a1,ffffffffc0203540 <do_fork+0x1e0>
ffffffffc020353a:	00d82023          	sw	a3,0(a6)
ffffffffc020353e:	8536                	mv	a0,a3
ffffffffc0203540:	f20889e3          	beqz	a7,ffffffffc0203472 <do_fork+0x112>
ffffffffc0203544:	00ce2023          	sw	a2,0(t3)
ffffffffc0203548:	b72d                	j	ffffffffc0203472 <do_fork+0x112>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020354a:	8936                	mv	s2,a3
ffffffffc020354c:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;//simulating as if twas returned from a trap handle
ffffffffc0203550:	00000797          	auipc	a5,0x0
ffffffffc0203554:	d1678793          	addi	a5,a5,-746 # ffffffffc0203266 <forkret>
ffffffffc0203558:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020355c:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203560:	100027f3          	csrr	a5,sstatus
ffffffffc0203564:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0203566:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203568:	ec078ce3          	beqz	a5,ffffffffc0203440 <do_fork+0xe0>
        intr_disable();
ffffffffc020356c:	bc4fd0ef          	jal	ra,ffffffffc0200930 <intr_disable>
    proc->parent = current;
ffffffffc0203570:	000a3303          	ld	t1,0(s4)
        return 1;
ffffffffc0203574:	4905                	li	s2,1
ffffffffc0203576:	b5e9                	j	ffffffffc0203440 <do_fork+0xe0>
        intr_enable();
ffffffffc0203578:	bb2fd0ef          	jal	ra,ffffffffc020092a <intr_enable>
ffffffffc020357c:	b799                	j	ffffffffc02034c2 <do_fork+0x162>
                    if (last_pid >= MAX_PID)
ffffffffc020357e:	01e6c363          	blt	a3,t5,ffffffffc0203584 <do_fork+0x224>
                        last_pid = 1;
ffffffffc0203582:	4685                	li	a3,1
                    goto repeat;
ffffffffc0203584:	4585                	li	a1,1
ffffffffc0203586:	bfbd                	j	ffffffffc0203504 <do_fork+0x1a4>
ffffffffc0203588:	cd81                	beqz	a1,ffffffffc02035a0 <do_fork+0x240>
ffffffffc020358a:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020358e:	8536                	mv	a0,a3
ffffffffc0203590:	b5cd                	j	ffffffffc0203472 <do_fork+0x112>
    kfree(proc);
ffffffffc0203592:	854e                	mv	a0,s3
ffffffffc0203594:	dcafe0ef          	jal	ra,ffffffffc0201b5e <kfree>
    ret = -E_NO_MEM;
ffffffffc0203598:	5571                	li	a0,-4
    goto fork_out;
ffffffffc020359a:	bf0d                	j	ffffffffc02034cc <do_fork+0x16c>
    int ret = -E_NO_FREE_PROC;
ffffffffc020359c:	556d                	li	a0,-5
ffffffffc020359e:	b73d                	j	ffffffffc02034cc <do_fork+0x16c>
    return last_pid;
ffffffffc02035a0:	00082503          	lw	a0,0(a6)
ffffffffc02035a4:	b5f9                	j	ffffffffc0203472 <do_fork+0x112>
    ret = -E_NO_MEM;
ffffffffc02035a6:	5571                	li	a0,-4
    return ret;
ffffffffc02035a8:	b715                	j	ffffffffc02034cc <do_fork+0x16c>
    assert(current->mm == NULL);
ffffffffc02035aa:	00002697          	auipc	a3,0x2
ffffffffc02035ae:	0de68693          	addi	a3,a3,222 # ffffffffc0205688 <default_pmm_manager+0x978>
ffffffffc02035b2:	00001617          	auipc	a2,0x1
ffffffffc02035b6:	3ae60613          	addi	a2,a2,942 # ffffffffc0204960 <commands+0x818>
ffffffffc02035ba:	13a00593          	li	a1,314
ffffffffc02035be:	00002517          	auipc	a0,0x2
ffffffffc02035c2:	0e250513          	addi	a0,a0,226 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc02035c6:	e95fc0ef          	jal	ra,ffffffffc020045a <__panic>
ffffffffc02035ca:	00001617          	auipc	a2,0x1
ffffffffc02035ce:	77e60613          	addi	a2,a2,1918 # ffffffffc0204d48 <default_pmm_manager+0x38>
ffffffffc02035d2:	07100593          	li	a1,113
ffffffffc02035d6:	00001517          	auipc	a0,0x1
ffffffffc02035da:	79a50513          	addi	a0,a0,1946 # ffffffffc0204d70 <default_pmm_manager+0x60>
ffffffffc02035de:	e7dfc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc02035e2 <kernel_thread>:
{   
ffffffffc02035e2:	7129                	addi	sp,sp,-320
ffffffffc02035e4:	fa22                	sd	s0,304(sp)
ffffffffc02035e6:	f626                	sd	s1,296(sp)
ffffffffc02035e8:	f24a                	sd	s2,288(sp)
ffffffffc02035ea:	84ae                	mv	s1,a1
ffffffffc02035ec:	892a                	mv	s2,a0
ffffffffc02035ee:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035f0:	4581                	li	a1,0
ffffffffc02035f2:	12000613          	li	a2,288
ffffffffc02035f6:	850a                	mv	a0,sp
{   
ffffffffc02035f8:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035fa:	095000ef          	jal	ra,ffffffffc0203e8e <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02035fe:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc0203600:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc0203602:	100027f3          	csrr	a5,sstatus
ffffffffc0203606:	edd7f793          	andi	a5,a5,-291
ffffffffc020360a:	1207e793          	ori	a5,a5,288
ffffffffc020360e:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0203610:	860a                	mv	a2,sp
ffffffffc0203612:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;//here,we move a0,s1,passing a para arg
ffffffffc0203616:	00000797          	auipc	a5,0x0
ffffffffc020361a:	be678793          	addi	a5,a5,-1050 # ffffffffc02031fc <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020361e:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;//here,we move a0,s1,passing a para arg
ffffffffc0203620:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0203622:	d3fff0ef          	jal	ra,ffffffffc0203360 <do_fork>
}
ffffffffc0203626:	70f2                	ld	ra,312(sp)
ffffffffc0203628:	7452                	ld	s0,304(sp)
ffffffffc020362a:	74b2                	ld	s1,296(sp)
ffffffffc020362c:	7912                	ld	s2,288(sp)
ffffffffc020362e:	6131                	addi	sp,sp,320
ffffffffc0203630:	8082                	ret

ffffffffc0203632 <do_exit>:
{
ffffffffc0203632:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc0203634:	00002617          	auipc	a2,0x2
ffffffffc0203638:	08460613          	addi	a2,a2,132 # ffffffffc02056b8 <default_pmm_manager+0x9a8>
ffffffffc020363c:	1a100593          	li	a1,417
ffffffffc0203640:	00002517          	auipc	a0,0x2
ffffffffc0203644:	06050513          	addi	a0,a0,96 # ffffffffc02056a0 <default_pmm_manager+0x990>
{
ffffffffc0203648:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc020364a:	e11fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020364e <proc_init>:
...
void proc_init(void)
{
ffffffffc020364e:	7179                	addi	sp,sp,-48
ffffffffc0203650:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc0203652:	0000a797          	auipc	a5,0xa
ffffffffc0203656:	e0678793          	addi	a5,a5,-506 # ffffffffc020d458 <proc_list>
ffffffffc020365a:	f406                	sd	ra,40(sp)
ffffffffc020365c:	f022                	sd	s0,32(sp)
ffffffffc020365e:	e84a                	sd	s2,16(sp)
ffffffffc0203660:	e44e                	sd	s3,8(sp)
ffffffffc0203662:	00006497          	auipc	s1,0x6
ffffffffc0203666:	de648493          	addi	s1,s1,-538 # ffffffffc0209448 <hash_list>
...
ffffffffc020366e:	0000a717          	auipc	a4,0xa
ffffffffc0203672:	dda70713          	addi	a4,a4,-550 # ffffffffc020d448 <name.2>
ffffffffc0203676:	87a6                	mv	a5,s1
ffffffffc0203678:	e79c                	sd	a5,8(a5)
ffffffffc020367a:	e39c                	sd	a5,0(a5)
ffffffffc020367c:	07c1                	addi	a5,a5,16
ffffffffc020367e:	fef71de3          	bne	a4,a5,ffffffffc0203678 <proc_init+0x2a>
    {
        list_init(hash_list + i);//them seems not linked,when used,they get linked
    }

    if ((idleproc = alloc_proc()) == NULL)//alloc
ffffffffc0203682:	b83ff0ef          	jal	ra,ffffffffc0203204 <alloc_proc>
ffffffffc0203686:	0000a917          	auipc	s2,0xa
ffffffffc020368a:	e5290913          	addi	s2,s2,-430 # ffffffffc020d4d8 <idleproc>
ffffffffc020368e:	00a93023          	sd	a0,0(s2)
ffffffffc0203692:	18050d63          	beqz	a0,ffffffffc020382c <proc_init+0x1de>
    {
...
ffffffffc0203696:	07000513          	li	a0,112
ffffffffc020369a:	c14fe0ef          	jal	ra,ffffffffc0201aae <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020369e:	07000613          	li	a2,112
ffffffffc02036a2:	4581                	li	a1,0
    int *context_mem = (int *)kmalloc(sizeof(struct context));
ffffffffc02036a4:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02036a6:	7e8000ef          	jal	ra,ffffffffc0203e8e <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc02036aa:	00093503          	ld	a0,0(s2)
ffffffffc02036ae:	85a2                	mv	a1,s0
ffffffffc02036b0:	07000613          	li	a2,112
ffffffffc02036b4:	03050513          	addi	a0,a0,48
ffffffffc02036b8:	001000ef          	jal	ra,ffffffffc0203eb8 <memcmp>
ffffffffc02036bc:	89aa                	mv	s3,a0

    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc02036be:	453d                	li	a0,15
ffffffffc02036c0:	beefe0ef          	jal	ra,ffffffffc0201aae <kmalloc>
...
ffffffffc02036c8:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02036ca:	7c4000ef          	jal	ra,ffffffffc0203e8e <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc02036ce:	00093503          	ld	a0,0(s2)
ffffffffc02036d2:	463d                	li	a2,15
ffffffffc02036d4:	85a2                	mv	a1,s0
ffffffffc02036d6:	0b450513          	addi	a0,a0,180
ffffffffc02036da:	7de000ef          	jal	ra,ffffffffc0203eb8 <memcmp>
...
ffffffffc02036e2:	0000a717          	auipc	a4,0xa
ffffffffc02036e6:	dbe73703          	ld	a4,-578(a4) # ffffffffc020d4a0 <boot_pgdir_pa>
ffffffffc02036ea:	77d4                	ld	a3,168(a5)
ffffffffc02036ec:	0ee68463          	beq	a3,a4,ffffffffc02037d4 <proc_init+0x186>
    {
...
ffffffffc02036f0:	4709                	li	a4,2
ffffffffc02036f2:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;//set kstack//for other proc,it should be gain especially,
ffffffffc02036f4:	00003717          	auipc	a4,0x3
ffffffffc02036f8:	90c70713          	addi	a4,a4,-1780 # ffffffffc0206000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036fc:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;//set kstack//for other proc,it should be gain especially,
ffffffffc0203700:	eb98                	sd	a4,16(a5)
...
ffffffffc0203702:	4705                	li	a4,1
ffffffffc0203704:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203706:	4641                	li	a2,16
ffffffffc0203708:	4581                	li	a1,0
ffffffffc020370a:	8522                	mv	a0,s0
ffffffffc020370c:	782000ef          	jal	ra,ffffffffc0203e8e <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0203710:	463d                	li	a2,15
ffffffffc0203712:	00002597          	auipc	a1,0x2
ffffffffc0203716:	fee58593          	addi	a1,a1,-18 # ffffffffc0205700 <default_pmm_manager+0x9f0>
ffffffffc020371a:	8522                	mv	a0,s0
ffffffffc020371c:	784000ef          	jal	ra,ffffffffc0203ea0 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc0203720:	0000a717          	auipc	a4,0xa
ffffffffc0203724:	dc870713          	addi	a4,a4,-568 # ffffffffc020d4e8 <nr_process>
ffffffffc0203728:	431c                	lw	a5,0(a4)
...
ffffffffc020372e:	4601                	li	a2,0
    nr_process++;
ffffffffc0203730:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0203732:	00002597          	auipc	a1,0x2
ffffffffc0203736:	fd658593          	addi	a1,a1,-42 # ffffffffc0205708 <default_pmm_manager+0x9f8>
ffffffffc020373a:	00000517          	auipc	a0,0x0
ffffffffc020373e:	b3a50513          	addi	a0,a0,-1222 # ffffffffc0203274 <init_main>
    nr_process++;
ffffffffc0203742:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0203744:	0000a797          	auipc	a5,0xa
ffffffffc0203748:	d8d7b623          	sd	a3,-628(a5) # ffffffffc020d4d0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020374c:	e97ff0ef          	jal	ra,ffffffffc02035e2 <kernel_thread>
ffffffffc0203750:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc0203752:	0ea05963          	blez	a0,ffffffffc0203844 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID)
ffffffffc0203756:	6789                	lui	a5,0x2
ffffffffc0203758:	fff5071b          	addiw	a4,a0,-1
ffffffffc020375c:	17f9                	addi	a5,a5,-2
ffffffffc020375e:	2501                	sext.w	a0,a0
ffffffffc0203760:	02e7e363          	bltu	a5,a4,ffffffffc0203786 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0203764:	45a9                	li	a1,10
ffffffffc0203766:	282000ef          	jal	ra,ffffffffc02039e8 <hash32>
ffffffffc020376a:	02051793          	slli	a5,a0,0x20
ffffffffc020376e:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0203772:	96a6                	add	a3,a3,s1
ffffffffc0203774:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc0203776:	a029                	j	ffffffffc0203780 <proc_init+0x132>
            if (proc->pid == pid)
ffffffffc0203778:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc020377c:	0a870563          	beq	a4,s0,ffffffffc0203826 <proc_init+0x1d8>
    return listelm->next;
ffffffffc0203780:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0203782:	fef69be3          	bne	a3,a5,ffffffffc0203778 <proc_init+0x12a>
    return NULL;
ffffffffc0203786:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203788:	0b478493          	addi	s1,a5,180
ffffffffc020378c:	4641                	li	a2,16
...
ffffffffc0203790:	0000a417          	auipc	s0,0xa
ffffffffc0203794:	d5040413          	addi	s0,s0,-688 # ffffffffc020d4e0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203798:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc020379a:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020379c:	6f2000ef          	jal	ra,ffffffffc0203e8e <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02037a0:	463d                	li	a2,15
ffffffffc02037a2:	00002597          	auipc	a1,0x2
ffffffffc02037a6:	f9658593          	addi	a1,a1,-106 # ffffffffc0205738 <default_pmm_manager+0xa28>
ffffffffc02037aa:	8526                	mv	a0,s1
ffffffffc02037ac:	6f4000ef          	jal	ra,ffffffffc0203ea0 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02037b0:	00093783          	ld	a5,0(s2)
ffffffffc02037b4:	c7e1                	beqz	a5,ffffffffc020387c <proc_init+0x22e>
ffffffffc02037b6:	43dc                	lw	a5,4(a5)
ffffffffc02037b8:	e3f1                	bnez	a5,ffffffffc020387c <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02037ba:	601c                	ld	a5,0(s0)
ffffffffc02037bc:	c3c5                	beqz	a5,ffffffffc020385c <proc_init+0x20e>
ffffffffc02037be:	43d8                	lw	a4,4(a5)
ffffffffc02037c0:	4785                	li	a5,1
ffffffffc02037c2:	08f71d63          	bne	a4,a5,ffffffffc020385c <proc_init+0x20e>
}
ffffffffc02037c6:	70a2                	ld	ra,40(sp)
ffffffffc02037c8:	7402                	ld	s0,32(sp)
ffffffffc02037ca:	64e2                	ld	s1,24(sp)
ffffffffc02037cc:	6942                	ld	s2,16(sp)
ffffffffc02037ce:	69a2                	ld	s3,8(sp)
ffffffffc02037d0:	6145                	addi	sp,sp,48
ffffffffc02037d2:	8082                	ret
    if (idleproc->pgdir == boot_pgdir_pa && idleproc->tf == NULL && !context_init_flag && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0 && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag)
ffffffffc02037d4:	73d8                	ld	a4,160(a5)
ffffffffc02037d6:	ff09                	bnez	a4,ffffffffc02036f0 <proc_init+0xa2>
ffffffffc02037d8:	f0099ce3          	bnez	s3,ffffffffc02036f0 <proc_init+0xa2>
ffffffffc02037dc:	6394                	ld	a3,0(a5)
ffffffffc02037de:	577d                	li	a4,-1
ffffffffc02037e0:	1702                	slli	a4,a4,0x20
ffffffffc02037e2:	f0e697e3          	bne	a3,a4,ffffffffc02036f0 <proc_init+0xa2>
ffffffffc02037e6:	4798                	lw	a4,8(a5)
ffffffffc02037e8:	f00714e3          	bnez	a4,ffffffffc02036f0 <proc_init+0xa2>
ffffffffc02037ec:	6b98                	ld	a4,16(a5)
ffffffffc02037ee:	f00711e3          	bnez	a4,ffffffffc02036f0 <proc_init+0xa2>
ffffffffc02037f2:	4f98                	lw	a4,24(a5)
ffffffffc02037f4:	2701                	sext.w	a4,a4
ffffffffc02037f6:	ee071de3          	bnez	a4,ffffffffc02036f0 <proc_init+0xa2>
ffffffffc02037fa:	7398                	ld	a4,32(a5)
ffffffffc02037fc:	ee071ae3          	bnez	a4,ffffffffc02036f0 <proc_init+0xa2>
ffffffffc0203800:	7798                	ld	a4,40(a5)
ffffffffc0203802:	ee0717e3          	bnez	a4,ffffffffc02036f0 <proc_init+0xa2>
ffffffffc0203806:	0b07a703          	lw	a4,176(a5)
ffffffffc020380a:	8d59                	or	a0,a0,a4
ffffffffc020380c:	0005071b          	sext.w	a4,a0
ffffffffc0203810:	ee0710e3          	bnez	a4,ffffffffc02036f0 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc0203814:	00002517          	auipc	a0,0x2
ffffffffc0203818:	ed450513          	addi	a0,a0,-300 # ffffffffc02056e8 <default_pmm_manager+0x9d8>
ffffffffc020381c:	979fc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    idleproc->pid = 0;//a leagal pid
ffffffffc0203820:	00093783          	ld	a5,0(s2)
ffffffffc0203824:	b5f1                	j	ffffffffc02036f0 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0203826:	f2878793          	addi	a5,a5,-216
ffffffffc020382a:	bfb9                	j	ffffffffc0203788 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc020382c:	00002617          	auipc	a2,0x2
ffffffffc0203830:	ea460613          	addi	a2,a2,-348 # ffffffffc02056d0 <default_pmm_manager+0x9c0>
ffffffffc0203834:	1bd00593          	li	a1,445
ffffffffc0203838:	00002517          	auipc	a0,0x2
ffffffffc020383c:	e6850513          	addi	a0,a0,-408 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc0203840:	c1bfc0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("create init_main failed.\n");
ffffffffc0203844:	00002617          	auipc	a2,0x2
ffffffffc0203848:	ed460613          	addi	a2,a2,-300 # ffffffffc0205718 <default_pmm_manager+0xa08>
ffffffffc020384c:	1dc00593          	li	a1,476
ffffffffc0203850:	00002517          	auipc	a0,0x2
ffffffffc0203854:	e5050513          	addi	a0,a0,-432 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc0203858:	c03fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020385c:	00002697          	auipc	a3,0x2
ffffffffc0203860:	f0c68693          	addi	a3,a3,-244 # ffffffffc0205768 <default_pmm_manager+0xa58>
ffffffffc0203864:	00001617          	auipc	a2,0x1
ffffffffc0203868:	0fc60613          	addi	a2,a2,252 # ffffffffc0204960 <commands+0x818>
ffffffffc020386c:	1e300593          	li	a1,483
ffffffffc0203870:	00002517          	auipc	a0,0x2
ffffffffc0203874:	e3050513          	addi	a0,a0,-464 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc0203878:	be3fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020387c:	00002697          	auipc	a3,0x2
ffffffffc0203880:	ec468693          	addi	a3,a3,-316 # ffffffffc0205740 <default_pmm_manager+0xa30>
ffffffffc0203884:	00001617          	auipc	a2,0x1
ffffffffc0203888:	0dc60613          	addi	a2,a2,220 # ffffffffc0204960 <commands+0x818>
ffffffffc020388c:	1e200593          	li	a1,482
ffffffffc0203890:	00002517          	auipc	a0,0x2
ffffffffc0203894:	e1050513          	addi	a0,a0,-496 # ffffffffc02056a0 <default_pmm_manager+0x990>
ffffffffc0203898:	bc3fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020389c <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void cpu_idle(void)
{
ffffffffc020389c:	1141                	addi	sp,sp,-16
ffffffffc020389e:	e022                	sd	s0,0(sp)
ffffffffc02038a0:	e406                	sd	ra,8(sp)
ffffffffc02038a2:	0000a417          	auipc	s0,0xa
ffffffffc02038a6:	c2e40413          	addi	s0,s0,-978 # ffffffffc020d4d0 <current>
    while (1)
    {
        if (current->need_resched)//when no other thread,free for
ffffffffc02038aa:	6018                	ld	a4,0(s0)
ffffffffc02038ac:	4f1c                	lw	a5,24(a4)
ffffffffc02038ae:	2781                	sext.w	a5,a5
ffffffffc02038b0:	dff5                	beqz	a5,ffffffffc02038ac <cpu_idle+0x10>
        {
            schedule();//choose runnable thread and switch,control->initproc
ffffffffc02038b2:	0a2000ef          	jal	ra,ffffffffc0203954 <schedule>
ffffffffc02038b6:	bfd5                	j	ffffffffc02038aa <cpu_idle+0xe>

ffffffffc02038b8 <switch_to>:
.text
# void switch_to(struct proc_struct* from, struct proc_struct* to)
.globl switch_to
switch_to:
    # save from's registers #save regs into a0+(i*REGBYTES)
    STORE ra, 0*REGBYTES(a0)
ffffffffc02038b8:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02038bc:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02038c0:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02038c2:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02038c4:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02038c8:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02038cc:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02038d0:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02038d4:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc02038d8:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc02038dc:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc02038e0:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc02038e4:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02038e8:	07b53423          	sd	s11,104(a0)

    # restore to's registers #read into regs
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02038ec:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02038f0:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02038f4:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02038f6:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02038f8:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02038fc:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0203900:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0203904:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0203908:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc020390c:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0203910:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0203914:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0203918:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc020391c:	0685bd83          	ld	s11,104(a1)

    # when proc_running init_proc,ret addr:forkret,__trapret
    ret
ffffffffc0203920:	8082                	ret

ffffffffc0203922 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0203922:	411c                	lw	a5,0(a0)
ffffffffc0203924:	4705                	li	a4,1
ffffffffc0203926:	37f9                	addiw	a5,a5,-2
ffffffffc0203928:	00f77563          	bgeu	a4,a5,ffffffffc0203932 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc020392c:	4789                	li	a5,2
ffffffffc020392e:	c11c                	sw	a5,0(a0)
ffffffffc0203930:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc0203932:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0203934:	00002697          	auipc	a3,0x2
ffffffffc0203938:	e5c68693          	addi	a3,a3,-420 # ffffffffc0205790 <default_pmm_manager+0xa80>
ffffffffc020393c:	00001617          	auipc	a2,0x1
ffffffffc0203940:	02460613          	addi	a2,a2,36 # ffffffffc0204960 <commands+0x818>
ffffffffc0203944:	45a5                	li	a1,9
ffffffffc0203946:	00002517          	auipc	a0,0x2
ffffffffc020394a:	e8a50513          	addi	a0,a0,-374 # ffffffffc02057d0 <default_pmm_manager+0xac0>
wakeup_proc(struct proc_struct *proc) {
ffffffffc020394e:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0203950:	b0bfc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc0203954 <schedule>:
}
//状态为RUNNABLE的进程会被选中
void
schedule(void) {
ffffffffc0203954:	1141                	addi	sp,sp,-16
ffffffffc0203956:	e406                	sd	ra,8(sp)
ffffffffc0203958:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020395a:	100027f3          	csrr	a5,sstatus
ffffffffc020395e:	8b89                	andi	a5,a5,2
ffffffffc0203960:	4401                	li	s0,0
ffffffffc0203962:	efbd                	bnez	a5,ffffffffc02039e0 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0203964:	0000a897          	auipc	a7,0xa
ffffffffc0203968:	b6c8b883          	ld	a7,-1172(a7) # ffffffffc020d4d0 <current>
ffffffffc020396c:	0008ac23          	sw	zero,24(a7)
        //if nowa idle:start search from head,else from next proc of temp
        //如果是idle进程，则从链表头开始寻找；否则从当前进程的下一个进程开始寻找
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0203970:	0000a517          	auipc	a0,0xa
ffffffffc0203974:	b6853503          	ld	a0,-1176(a0) # ffffffffc020d4d8 <idleproc>
ffffffffc0203978:	04a88e63          	beq	a7,a0,ffffffffc02039d4 <schedule+0x80>
ffffffffc020397c:	0c888693          	addi	a3,a7,200
ffffffffc0203980:	0000a617          	auipc	a2,0xa
ffffffffc0203984:	ad860613          	addi	a2,a2,-1320 # ffffffffc020d458 <proc_list>
        le = last;
ffffffffc0203988:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc020398a:	4581                	li	a1,0
        do {// 查找一个RUNNABLE状态的进程
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {//ve founded the one
ffffffffc020398c:	4809                	li	a6,2
ffffffffc020398e:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0203990:	00c78863          	beq	a5,a2,ffffffffc02039a0 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {//ve founded the one
ffffffffc0203994:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0203998:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {//ve founded the one
ffffffffc020399c:	03070163          	beq	a4,a6,ffffffffc02039be <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02039a0:	fef697e3          	bne	a3,a5,ffffffffc020398e <schedule+0x3a>
        //如果最后没有找到RUNNABLE状态的进程，就用idle进程保底
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02039a4:	ed89                	bnez	a1,ffffffffc02039be <schedule+0x6a>
            next = idleproc;//not runnable found
        }
        //增加该进程运行次数
        next->runs ++;//count++
ffffffffc02039a6:	451c                	lw	a5,8(a0)
ffffffffc02039a8:	2785                	addiw	a5,a5,1
ffffffffc02039aa:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc02039ac:	00a88463          	beq	a7,a0,ffffffffc02039b4 <schedule+0x60>
            proc_run(next);//run the founded runnable proc
ffffffffc02039b0:	937ff0ef          	jal	ra,ffffffffc02032e6 <proc_run>
    if (flag) {
ffffffffc02039b4:	e819                	bnez	s0,ffffffffc02039ca <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc02039b6:	60a2                	ld	ra,8(sp)
ffffffffc02039b8:	6402                	ld	s0,0(sp)
ffffffffc02039ba:	0141                	addi	sp,sp,16
ffffffffc02039bc:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02039be:	4198                	lw	a4,0(a1)
ffffffffc02039c0:	4789                	li	a5,2
ffffffffc02039c2:	fef712e3          	bne	a4,a5,ffffffffc02039a6 <schedule+0x52>
ffffffffc02039c6:	852e                	mv	a0,a1
ffffffffc02039c8:	bff9                	j	ffffffffc02039a6 <schedule+0x52>
}
ffffffffc02039ca:	6402                	ld	s0,0(sp)
ffffffffc02039cc:	60a2                	ld	ra,8(sp)
ffffffffc02039ce:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02039d0:	f5bfc06f          	j	ffffffffc020092a <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02039d4:	0000a617          	auipc	a2,0xa
ffffffffc02039d8:	a8460613          	addi	a2,a2,-1404 # ffffffffc020d458 <proc_list>
ffffffffc02039dc:	86b2                	mv	a3,a2
ffffffffc02039de:	b76d                	j	ffffffffc0203988 <schedule+0x34>
        intr_disable();
ffffffffc02039e0:	f51fc0ef          	jal	ra,ffffffffc0200930 <intr_disable>
        return 1;
ffffffffc02039e4:	4405                	li	s0,1
ffffffffc02039e6:	bfbd                	j	ffffffffc0203964 <schedule+0x10>

ffffffffc02039e8 <hash32>:
 *
...
ffffffffc02039e8:	9e3707b7          	lui	a5,0x9e370
ffffffffc02039ec:	2785                	addiw	a5,a5,1
ffffffffc02039ee:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02039f2:	02000793          	li	a5,32
ffffffffc02039f6:	9f8d                	subw	a5,a5,a1
}
ffffffffc02039f8:	00f5553b          	srlw	a0,a0,a5
ffffffffc02039fc:	8082                	ret

ffffffffc02039fe <printnum>:
 * */
static void
...
ffffffffc02039fe:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203a02:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203a04:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203a08:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203a0a:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203a0e:	f022                	sd	s0,32(sp)
ffffffffc0203a10:	ec26                	sd	s1,24(sp)
ffffffffc0203a12:	e84a                	sd	s2,16(sp)
ffffffffc0203a14:	f406                	sd	ra,40(sp)
ffffffffc0203a16:	e44e                	sd	s3,8(sp)
ffffffffc0203a18:	84aa                	mv	s1,a0
ffffffffc0203a1a:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203a1c:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203a20:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203a22:	03067e63          	bgeu	a2,a6,ffffffffc0203a5e <printnum+0x60>
ffffffffc0203a26:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203a28:	00805763          	blez	s0,ffffffffc0203a36 <printnum+0x38>
ffffffffc0203a2c:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203a2e:	85ca                	mv	a1,s2
ffffffffc0203a30:	854e                	mv	a0,s3
ffffffffc0203a32:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203a34:	fc65                	bnez	s0,ffffffffc0203a2c <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a36:	1a02                	slli	s4,s4,0x20
ffffffffc0203a38:	00002797          	auipc	a5,0x2
ffffffffc0203a3c:	db078793          	addi	a5,a5,-592 # ffffffffc02057e8 <default_pmm_manager+0xad8>
ffffffffc0203a40:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203a44:	9a3e                	add	s4,s4,a5
}
ffffffffc0203a46:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a48:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203a4c:	70a2                	ld	ra,40(sp)
ffffffffc0203a4e:	69a2                	ld	s3,8(sp)
ffffffffc0203a50:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a52:	85ca                	mv	a1,s2
ffffffffc0203a54:	87a6                	mv	a5,s1
}
ffffffffc0203a56:	6942                	ld	s2,16(sp)
ffffffffc0203a58:	64e2                	ld	s1,24(sp)
ffffffffc0203a5a:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a5c:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203a5e:	03065633          	divu	a2,a2,a6
ffffffffc0203a62:	8722                	mv	a4,s0
ffffffffc0203a64:	f9bff0ef          	jal	ra,ffffffffc02039fe <printnum>
ffffffffc0203a68:	b7f9                	j	ffffffffc0203a36 <printnum+0x38>

ffffffffc0203a6a <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203a6a:	7119                	addi	sp,sp,-128
ffffffffc0203a6c:	f4a6                	sd	s1,104(sp)
ffffffffc0203a6e:	f0ca                	sd	s2,96(sp)
ffffffffc0203a70:	ecce                	sd	s3,88(sp)
ffffffffc0203a72:	e8d2                	sd	s4,80(sp)
ffffffffc0203a74:	e4d6                	sd	s5,72(sp)
ffffffffc0203a76:	e0da                	sd	s6,64(sp)
ffffffffc0203a78:	fc5e                	sd	s7,56(sp)
ffffffffc0203a7a:	f06a                	sd	s10,32(sp)
ffffffffc0203a7c:	fc86                	sd	ra,120(sp)
ffffffffc0203a7e:	f8a2                	sd	s0,112(sp)
ffffffffc0203a80:	f862                	sd	s8,48(sp)
ffffffffc0203a82:	f466                	sd	s9,40(sp)
ffffffffc0203a84:	ec6e                	sd	s11,24(sp)
ffffffffc0203a86:	892a                	mv	s2,a0
ffffffffc0203a88:	84ae                	mv	s1,a1
ffffffffc0203a8a:	8d32                	mv	s10,a2
ffffffffc0203a8c:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203a8e:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203a92:	5b7d                	li	s6,-1
ffffffffc0203a94:	00002a97          	auipc	s5,0x2
ffffffffc0203a98:	d80a8a93          	addi	s5,s5,-640 # ffffffffc0205814 <default_pmm_manager+0xb04>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203a9c:	00002b97          	auipc	s7,0x2
ffffffffc0203aa0:	f54b8b93          	addi	s7,s7,-172 # ffffffffc02059f0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203aa4:	000d4503          	lbu	a0,0(s10)
ffffffffc0203aa8:	001d0413          	addi	s0,s10,1
ffffffffc0203aac:	01350a63          	beq	a0,s3,ffffffffc0203ac0 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203ab0:	c121                	beqz	a0,ffffffffc0203af0 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203ab2:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203ab4:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203ab6:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203ab8:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203abc:	ff351ae3          	bne	a0,s3,ffffffffc0203ab0 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ac0:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203ac4:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203ac8:	4c81                	li	s9,0
ffffffffc0203aca:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203acc:	5c7d                	li	s8,-1
ffffffffc0203ace:	5dfd                	li	s11,-1
ffffffffc0203ad0:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203ad4:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ad6:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203ada:	0ff5f593          	zext.b	a1,a1
ffffffffc0203ade:	00140d13          	addi	s10,s0,1
ffffffffc0203ae2:	04b56263          	bltu	a0,a1,ffffffffc0203b26 <vprintfmt+0xbc>
ffffffffc0203ae6:	058a                	slli	a1,a1,0x2
ffffffffc0203ae8:	95d6                	add	a1,a1,s5
ffffffffc0203aea:	4194                	lw	a3,0(a1)
ffffffffc0203aec:	96d6                	add	a3,a3,s5
ffffffffc0203aee:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203af0:	70e6                	ld	ra,120(sp)
ffffffffc0203af2:	7446                	ld	s0,112(sp)
ffffffffc0203af4:	74a6                	ld	s1,104(sp)
ffffffffc0203af6:	7906                	ld	s2,96(sp)
ffffffffc0203af8:	69e6                	ld	s3,88(sp)
ffffffffc0203afa:	6a46                	ld	s4,80(sp)
ffffffffc0203afc:	6aa6                	ld	s5,72(sp)
ffffffffc0203afe:	6b06                	ld	s6,64(sp)
ffffffffc0203b00:	7be2                	ld	s7,56(sp)
ffffffffc0203b02:	7c42                	ld	s8,48(sp)
ffffffffc0203b04:	7ca2                	ld	s9,40(sp)
ffffffffc0203b06:	7d02                	ld	s10,32(sp)
ffffffffc0203b08:	6de2                	ld	s11,24(sp)
ffffffffc0203b0a:	6109                	addi	sp,sp,128
ffffffffc0203b0c:	8082                	ret
            padc = '0';
ffffffffc0203b0e:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203b10:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b14:	846a                	mv	s0,s10
ffffffffc0203b16:	00140d13          	addi	s10,s0,1
ffffffffc0203b1a:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203b1e:	0ff5f593          	zext.b	a1,a1
ffffffffc0203b22:	fcb572e3          	bgeu	a0,a1,ffffffffc0203ae6 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203b26:	85a6                	mv	a1,s1
ffffffffc0203b28:	02500513          	li	a0,37
ffffffffc0203b2c:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203b2e:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203b32:	8d22                	mv	s10,s0
ffffffffc0203b34:	f73788e3          	beq	a5,s3,ffffffffc0203aa4 <vprintfmt+0x3a>
ffffffffc0203b38:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203b3c:	1d7d                	addi	s10,s10,-1
ffffffffc0203b3e:	ff379de3          	bne	a5,s3,ffffffffc0203b38 <vprintfmt+0xce>
ffffffffc0203b42:	b78d                	j	ffffffffc0203aa4 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203b44:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc0203b4e:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203b52:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b56:	02d86463          	bltu	a6,a3,ffffffffc0203b7e <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203b5a:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203b5e:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203b62:	0186873b          	addw	a4,a3,s8
ffffffffc0203b66:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203b6a:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203b6c:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203b70:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203b72:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203b76:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b7a:	fed870e3          	bgeu	a6,a3,ffffffffc0203b5a <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203b7e:	f40ddce3          	bgez	s11,ffffffffc0203ad6 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203b82:	8de2                	mv	s11,s8
ffffffffc0203b84:	5c7d                	li	s8,-1
ffffffffc0203b86:	bf81                	j	ffffffffc0203ad6 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203b88:	fffdc693          	not	a3,s11
ffffffffc0203b8c:	96fd                	srai	a3,a3,0x3f
ffffffffc0203b8e:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b92:	00144603          	lbu	a2,1(s0)
ffffffffc0203b96:	2d81                	sext.w	s11,s11
ffffffffc0203b98:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203b9a:	bf35                	j	ffffffffc0203ad6 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0203b9c:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ba0:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203ba4:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ba6:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0203ba8:	bfd9                	j	ffffffffc0203b7e <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0203baa:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203bac:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203bb0:	01174463          	blt	a4,a7,ffffffffc0203bb8 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0203bb4:	1a088e63          	beqz	a7,ffffffffc0203d70 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0203bb8:	000a3603          	ld	a2,0(s4)
ffffffffc0203bbc:	46c1                	li	a3,16
ffffffffc0203bbe:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203bc0:	2781                	sext.w	a5,a5
ffffffffc0203bc2:	876e                	mv	a4,s11
ffffffffc0203bc4:	85a6                	mv	a1,s1
ffffffffc0203bc6:	854a                	mv	a0,s2
ffffffffc0203bc8:	e37ff0ef          	jal	ra,ffffffffc02039fe <printnum>
            break;
ffffffffc0203bcc:	bde1                	j	ffffffffc0203aa4 <vprintfmt+0x3a>
...
ffffffffc0203bd6:	9902                	jalr	s2
            break;
ffffffffc0203bd8:	b5f1                	j	ffffffffc0203aa4 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203bda:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203bdc:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203be0:	01174463          	blt	a4,a7,ffffffffc0203be8 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0203be4:	18088163          	beqz	a7,ffffffffc0203d66 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0203be8:	000a3603          	ld	a2,0(s4)
ffffffffc0203bec:	46a9                	li	a3,10
ffffffffc0203bee:	8a2e                	mv	s4,a1
ffffffffc0203bf0:	bfc1                	j	ffffffffc0203bc0 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bf2:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203bf6:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bf8:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203bfa:	bdf1                	j	ffffffffc0203ad6 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0203bfc:	85a6                	mv	a1,s1
ffffffffc0203bfe:	02500513          	li	a0,37
ffffffffc0203c02:	9902                	jalr	s2
            break;
ffffffffc0203c04:	b545                	j	ffffffffc0203aa4 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203c06:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0203c0a:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203c0c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203c0e:	b5e1                	j	ffffffffc0203ad6 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0203c10:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203c12:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203c16:	01174463          	blt	a4,a7,ffffffffc0203c1e <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0203c1a:	14088163          	beqz	a7,ffffffffc0203d5c <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0203c1e:	000a3603          	ld	a2,0(s4)
ffffffffc0203c22:	46a1                	li	a3,8
ffffffffc0203c24:	8a2e                	mv	s4,a1
ffffffffc0203c26:	bf69                	j	ffffffffc0203bc0 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0203c28:	03000513          	li	a0,48
ffffffffc0203c2c:	85a6                	mv	a1,s1
ffffffffc0203c2e:	e03e                	sd	a5,0(sp)
ffffffffc0203c30:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203c32:	85a6                	mv	a1,s1
ffffffffc0203c34:	07800513          	li	a0,120
ffffffffc0203c38:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203c3a:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0203c3c:	6782                	ld	a5,0(sp)
ffffffffc0203c3e:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203c40:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0203c44:	bfb5                	j	ffffffffc0203bc0 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203c46:	000a3403          	ld	s0,0(s4)
ffffffffc0203c4a:	008a0713          	addi	a4,s4,8
ffffffffc0203c4e:	e03a                	sd	a4,0(sp)
ffffffffc0203c50:	14040263          	beqz	s0,ffffffffc0203d94 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0203c54:	0fb05763          	blez	s11,ffffffffc0203d42 <vprintfmt+0x2d8>
ffffffffc0203c58:	02d00693          	li	a3,45
ffffffffc0203c5c:	0cd79163          	bne	a5,a3,ffffffffc0203d1e <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c60:	00044783          	lbu	a5,0(s0)
ffffffffc0203c64:	0007851b          	sext.w	a0,a5
ffffffffc0203c68:	cf85                	beqz	a5,ffffffffc0203ca0 <vprintfmt+0x236>
ffffffffc0203c6a:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c6e:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c72:	000c4563          	bltz	s8,ffffffffc0203c7c <vprintfmt+0x212>
ffffffffc0203c76:	3c7d                	addiw	s8,s8,-1
ffffffffc0203c78:	036c0263          	beq	s8,s6,ffffffffc0203c9c <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0203c7c:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c7e:	0e0c8e63          	beqz	s9,ffffffffc0203d7a <vprintfmt+0x310>
ffffffffc0203c82:	3781                	addiw	a5,a5,-32
ffffffffc0203c84:	0ef47b63          	bgeu	s0,a5,ffffffffc0203d7a <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0203c88:	03f00513          	li	a0,63
ffffffffc0203c8c:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c8e:	000a4783          	lbu	a5,0(s4)
ffffffffc0203c92:	3dfd                	addiw	s11,s11,-1
ffffffffc0203c94:	0a05                	addi	s4,s4,1
ffffffffc0203c96:	0007851b          	sext.w	a0,a5
ffffffffc0203c9a:	ffe1                	bnez	a5,ffffffffc0203c72 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0203c9c:	01b05963          	blez	s11,ffffffffc0203cae <vprintfmt+0x244>
ffffffffc0203ca0:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203ca2:	85a6                	mv	a1,s1
ffffffffc0203ca4:	02000513          	li	a0,32
ffffffffc0203ca8:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203caa:	fe0d9be3          	bnez	s11,ffffffffc0203ca0 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203cae:	6a02                	ld	s4,0(sp)
ffffffffc0203cb0:	bbd5                	j	ffffffffc0203aa4 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203cb2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203cb4:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0203cb8:	01174463          	blt	a4,a7,ffffffffc0203cc0 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0203cbc:	08088d63          	beqz	a7,ffffffffc0203d56 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0203cc0:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0203cc4:	0a044d63          	bltz	s0,ffffffffc0203d7e <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0203cc8:	8622                	mv	a2,s0
ffffffffc0203cca:	8a66                	mv	s4,s9
ffffffffc0203ccc:	46a9                	li	a3,10
ffffffffc0203cce:	bdcd                	j	ffffffffc0203bc0 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0203cd0:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203cd4:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203cd6:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0203cd8:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203cdc:	8fb5                	xor	a5,a5,a3
ffffffffc0203cde:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203ce2:	02d74163          	blt	a4,a3,ffffffffc0203d04 <vprintfmt+0x29a>
ffffffffc0203ce6:	00369793          	slli	a5,a3,0x3
ffffffffc0203cea:	97de                	add	a5,a5,s7
ffffffffc0203cec:	639c                	ld	a5,0(a5)
ffffffffc0203cee:	cb99                	beqz	a5,ffffffffc0203d04 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203cf0:	86be                	mv	a3,a5
ffffffffc0203cf2:	00000617          	auipc	a2,0x0
ffffffffc0203cf6:	21660613          	addi	a2,a2,534 # ffffffffc0203f08 <etext+0x2c>
ffffffffc0203cfa:	85a6                	mv	a1,s1
ffffffffc0203cfc:	854a                	mv	a0,s2
ffffffffc0203cfe:	0ce000ef          	jal	ra,ffffffffc0203dcc <printfmt>
ffffffffc0203d02:	b34d                	j	ffffffffc0203aa4 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0203d04:	00002617          	auipc	a2,0x2
ffffffffc0203d08:	b0460613          	addi	a2,a2,-1276 # ffffffffc0205808 <default_pmm_manager+0xaf8>
ffffffffc0203d0c:	85a6                	mv	a1,s1
ffffffffc0203d0e:	854a                	mv	a0,s2
ffffffffc0203d10:	0bc000ef          	jal	ra,ffffffffc0203dcc <printfmt>
ffffffffc0203d14:	bb41                	j	ffffffffc0203aa4 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0203d16:	00002417          	auipc	s0,0x2
ffffffffc0203d1a:	aea40413          	addi	s0,s0,-1302 # ffffffffc0205800 <default_pmm_manager+0xaf0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203d1e:	85e2                	mv	a1,s8
ffffffffc0203d20:	8522                	mv	a0,s0
ffffffffc0203d22:	e43e                	sd	a5,8(sp)
ffffffffc0203d24:	0e2000ef          	jal	ra,ffffffffc0203e06 <strnlen>
ffffffffc0203d28:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0203d2c:	01b05b63          	blez	s11,ffffffffc0203d42 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0203d30:	67a2                	ld	a5,8(sp)
ffffffffc0203d32:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203d36:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0203d38:	85a6                	mv	a1,s1
ffffffffc0203d3a:	8552                	mv	a0,s4
ffffffffc0203d3c:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203d3e:	fe0d9ce3          	bnez	s11,ffffffffc0203d36 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203d42:	00044783          	lbu	a5,0(s0)
ffffffffc0203d46:	00140a13          	addi	s4,s0,1
ffffffffc0203d4a:	0007851b          	sext.w	a0,a5
ffffffffc0203d4e:	d3a5                	beqz	a5,ffffffffc0203cae <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203d50:	05e00413          	li	s0,94
ffffffffc0203d54:	bf39                	j	ffffffffc0203c72 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0203d56:	000a2403          	lw	s0,0(s4)
ffffffffc0203d5a:	b7ad                	j	ffffffffc0203cc4 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0203d5c:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d60:	46a1                	li	a3,8
ffffffffc0203d62:	8a2e                	mv	s4,a1
ffffffffc0203d64:	bdb1                	j	ffffffffc0203bc0 <vprintfmt+0x156>
ffffffffc0203d66:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d6a:	46a9                	li	a3,10
ffffffffc0203d6c:	8a2e                	mv	s4,a1
ffffffffc0203d6e:	bd89                	j	ffffffffc0203bc0 <vprintfmt+0x156>
ffffffffc0203d70:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d74:	46c1                	li	a3,16
ffffffffc0203d76:	8a2e                	mv	s4,a1
ffffffffc0203d78:	b5a1                	j	ffffffffc0203bc0 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0203d7a:	9902                	jalr	s2
ffffffffc0203d7c:	bf09                	j	ffffffffc0203c8e <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0203d7e:	85a6                	mv	a1,s1
ffffffffc0203d80:	02d00513          	li	a0,45
ffffffffc0203d84:	e03e                	sd	a5,0(sp)
ffffffffc0203d86:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0203d88:	6782                	ld	a5,0(sp)
ffffffffc0203d8a:	8a66                	mv	s4,s9
ffffffffc0203d8c:	40800633          	neg	a2,s0
ffffffffc0203d90:	46a9                	li	a3,10
ffffffffc0203d92:	b53d                	j	ffffffffc0203bc0 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0203d94:	03b05163          	blez	s11,ffffffffc0203db6 <vprintfmt+0x34c>
ffffffffc0203d98:	02d00693          	li	a3,45
ffffffffc0203d9c:	f6d79de3          	bne	a5,a3,ffffffffc0203d16 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0203da0:	00002417          	auipc	s0,0x2
ffffffffc0203da4:	a6040413          	addi	s0,s0,-1440 # ffffffffc0205800 <default_pmm_manager+0xaf0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203da8:	02800793          	li	a5,40
ffffffffc0203dac:	02800513          	li	a0,40
ffffffffc0203db0:	00140a13          	addi	s4,s0,1
ffffffffc0203db4:	bd6d                	j	ffffffffc0203c6e <vprintfmt+0x204>
ffffffffc0203db6:	00002a17          	auipc	s4,0x2
ffffffffc0203dba:	a4ba0a13          	addi	s4,s4,-1461 # ffffffffc0205801 <default_pmm_manager+0xaf1>
ffffffffc0203dbe:	02800513          	li	a0,40
ffffffffc0203dc2:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203dc6:	05e00413          	li	s0,94
ffffffffc0203dca:	b565                	j	ffffffffc0203c72 <vprintfmt+0x208>

ffffffffc0203dcc <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203dcc:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0203dce:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203dd2:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203dd4:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203dd6:	ec06                	sd	ra,24(sp)
ffffffffc0203dd8:	f83a                	sd	a4,48(sp)
ffffffffc0203dda:	fc3e                	sd	a5,56(sp)
ffffffffc0203ddc:	e0c2                	sd	a6,64(sp)
ffffffffc0203dde:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0203de0:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203de2:	c89ff0ef          	jal	ra,ffffffffc0203a6a <vprintfmt>
}
ffffffffc0203de6:	60e2                	ld	ra,24(sp)
ffffffffc0203de8:	6161                	addi	sp,sp,80
ffffffffc0203dea:	8082                	ret

ffffffffc0203dec <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0203dec:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0203df0:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0203df2:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0203df4:	cb81                	beqz	a5,ffffffffc0203e04 <strlen+0x18>
        cnt ++;
ffffffffc0203df6:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0203df8:	00a707b3          	add	a5,a4,a0
ffffffffc0203dfc:	0007c783          	lbu	a5,0(a5)
ffffffffc0203e00:	fbfd                	bnez	a5,ffffffffc0203df6 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0203e06:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203e08:	e589                	bnez	a1,ffffffffc0203e12 <strnlen+0xc>
ffffffffc0203e0a:	a811                	j	ffffffffc0203e1e <strnlen+0x18>
        cnt ++;
ffffffffc0203e0c:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203e0e:	00f58863          	beq	a1,a5,ffffffffc0203e1e <strnlen+0x18>
ffffffffc0203e12:	00f50733          	add	a4,a0,a5
ffffffffc0203e16:	00074703          	lbu	a4,0(a4)
ffffffffc0203e1a:	fb6d                	bnez	a4,ffffffffc0203e0c <strnlen+0x6>
ffffffffc0203e1c:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0203e1e:	852e                	mv	a0,a1
ffffffffc0203e20:	8082                	ret

ffffffffc0203e22 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0203e22:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0203e24:	0005c703          	lbu	a4,0(a1)
ffffffffc0203e28:	0785                	addi	a5,a5,1
ffffffffc0203e2a:	0585                	addi	a1,a1,1
ffffffffc0203e2c:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0203e30:	fb75                	bnez	a4,ffffffffc0203e24 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0203e38:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203e3c:	cb89                	beqz	a5,ffffffffc0203e4e <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0203e3e:	0505                	addi	a0,a0,1
ffffffffc0203e40:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203e42:	fee789e3          	beq	a5,a4,ffffffffc0203e34 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e46:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0203e4a:	9d19                	subw	a0,a0,a4
ffffffffc0203e4c:	8082                	ret
ffffffffc0203e4e:	4501                	li	a0,0
ffffffffc0203e50:	bfed                	j	ffffffffc0203e4a <strcmp+0x16>

ffffffffc0203e52 <strncmp>:
...
ffffffffc0203e52:	c20d                	beqz	a2,ffffffffc0203e74 <strncmp+0x22>
ffffffffc0203e54:	962e                	add	a2,a2,a1
ffffffffc0203e56:	a031                	j	ffffffffc0203e62 <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc0203e58:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e5a:	00e79a63          	bne	a5,a4,ffffffffc0203e6e <strncmp+0x1c>
ffffffffc0203e5e:	00b60b63          	beq	a2,a1,ffffffffc0203e74 <strncmp+0x22>
ffffffffc0203e62:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0203e66:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e68:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0203e6c:	f7f5                	bnez	a5,ffffffffc0203e58 <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e6e:	40e7853b          	subw	a0,a5,a4
}
...
ffffffffc0203e7c:	c799                	beqz	a5,ffffffffc0203e8a <strchr+0x12>
        if (*s == c) {
ffffffffc0203e7e:	00f58763          	beq	a1,a5,ffffffffc0203e8c <strchr+0x14>
    while (*s != '\0') {
ffffffffc0203e82:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0203e86:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0203e88:	fbfd                	bnez	a5,ffffffffc0203e7e <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0203e8e:	ca01                	beqz	a2,ffffffffc0203e9e <memset+0x10>
ffffffffc0203e90:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0203e92:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0203e94:	0785                	addi	a5,a5,1
ffffffffc0203e96:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0203e9a:	fec79de3          	bne	a5,a2,ffffffffc0203e94 <memset+0x6>
    }
    return s;
...
ffffffffc0203ea0 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0203ea0:	ca19                	beqz	a2,ffffffffc0203eb6 <memcpy+0x16>
ffffffffc0203ea2:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0203ea4:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0203ea6:	0005c703          	lbu	a4,0(a1)
ffffffffc0203eaa:	0585                	addi	a1,a1,1
ffffffffc0203eac:	0785                	addi	a5,a5,1
ffffffffc0203eae:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0203eb2:	fec59ae3          	bne	a1,a2,ffffffffc0203ea6 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0203eb8:	c205                	beqz	a2,ffffffffc0203ed8 <memcmp+0x20>
ffffffffc0203eba:	962e                	add	a2,a2,a1
ffffffffc0203ebc:	a019                	j	ffffffffc0203ec2 <memcmp+0xa>
ffffffffc0203ebe:	00c58d63          	beq	a1,a2,ffffffffc0203ed8 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0203ecc:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0203ece:	fee788e3          	beq	a5,a4,ffffffffc0203ebe <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203ed2:	40e7853b          	subw	a0,a5,a4
