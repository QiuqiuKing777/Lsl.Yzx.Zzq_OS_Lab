...
obj/__user_cow_ro.out:     file format elf64-littleriscv
...
exit(int error_code) {
  ...
  8000d8:	49c50513          	addi	a0,a0,1180 # 800570 <main+0x72>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800132:	45a78793          	addi	a5,a5,1114 # 800588 <main+0x8a>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018e:	432a8a93          	addi	s5,s5,1074 # 8005bc <main+0xbe>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800196:	646b8b93          	addi	s7,s7,1606 # 8007d8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ec:	1d060613          	addi	a2,a2,464 # 8005b8 <main+0xba>
  ...
  8003fe:	1ae60613          	addi	a2,a2,430 # 8005a8 <main+0xaa>
  ...
  800410:	19440413          	addi	s0,s0,404 # 8005a0 <main+0xa2>
  ...
  80049a:	10a40413          	addi	s0,s0,266 # 8005a0 <main+0xa2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004b0:	0f5a0a13          	addi	s4,s4,245 # 8005a1 <main+0xa3>
...
int main(void) {
  ...
  800502:	be5ff0ef          	jal	ra,8000e6 <getpid>
  800506:	00000697          	auipc	a3,0x0
  80050a:	39a68693          	addi	a3,a3,922 # 8008a0 <error_string+0xc8>
  80050e:	85aa                	mv	a1,a0
  800510:	8636                	mv	a2,a3
  800512:	00000517          	auipc	a0,0x0
  800516:	39e50513          	addi	a0,a0,926 # 8008b0 <error_string+0xd8>
  80051a:	b27ff0ef          	jal	ra,800040 <cprintf>

    int pid = fork();
  80051e:	bc5ff0ef          	jal	ra,8000e2 <fork>
    if (pid == 0) {
  800522:	c50d                	beqz	a0,80054c <main+0x4e>
    ...
    waitpid(pid,NULL);
  800524:	4581                	li	a1,0
  800526:	bbfff0ef          	jal	ra,8000e4 <waitpid>
    cprintf("[cow_ro-parent] pid=%d s=%s\n", getpid(), s);
  80052a:	bbdff0ef          	jal	ra,8000e6 <getpid>
  80052e:	85aa                	mv	a1,a0
  800530:	00000617          	auipc	a2,0x0
  800534:	37060613          	addi	a2,a2,880 # 8008a0 <error_string+0xc8>
  800538:	00000517          	auipc	a0,0x0
  80053c:	3c050513          	addi	a0,a0,960 # 8008f8 <error_string+0x120>
  800540:	b01ff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  800544:	60a2                	ld	ra,8(sp)
  800546:	4501                	li	a0,0
  800548:	0141                	addi	sp,sp,16
  80054a:	8082                	ret
        cprintf("[cow_ro-child] pid=%d s=%s\n", getpid(), s);
  80054c:	b9bff0ef          	jal	ra,8000e6 <getpid>
  800550:	85aa                	mv	a1,a0
  800552:	00000617          	auipc	a2,0x0
  800556:	34e60613          	addi	a2,a2,846 # 8008a0 <error_string+0xc8>
  80055a:	00000517          	auipc	a0,0x0
  80055e:	37e50513          	addi	a0,a0,894 # 8008d8 <error_string+0x100>
  800562:	adfff0ef          	jal	ra,800040 <cprintf>
        exit(0);
  800566:	4501                	li	a0,0
  800568:	b65ff0ef          	jal	ra,8000cc <exit>
