...
exit(int error_code) {
  ...
  8000d8:	4d450513          	addi	a0,a0,1236 # 8005a8 <main+0xaa>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800132:	49278793          	addi	a5,a5,1170 # 8005c0 <main+0xc2>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018e:	46aa8a93          	addi	s5,s5,1130 # 8005f4 <main+0xf6>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800196:	67eb8b93          	addi	s7,s7,1662 # 800810 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ec:	20860613          	addi	a2,a2,520 # 8005f0 <main+0xf2>
  ...
  8003fe:	1e660613          	addi	a2,a2,486 # 8005e0 <main+0xe2>
  ...
  800410:	1cc40413          	addi	s0,s0,460 # 8005d8 <main+0xda>
  ...
  80049a:	14240413          	addi	s0,s0,322 # 8005d8 <main+0xda>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004b0:	12da0a13          	addi	s4,s4,301 # 8005d9 <main+0xdb>
...
int main(void) {
  ...
  800504:	f022                	sd	s0,32(sp)
  800506:	ec26                	sd	s1,24(sp)
  800508:	e84a                	sd	s2,16(sp)
    int x = 3;
  80050a:	c63e                	sw	a5,12(sp)
    cprintf("[cow_multi] parent pid=%d initial x=%d (addr=%p)\n", getpid(), x, &x);
  80050c:	bdbff0ef          	jal	ra,8000e6 <getpid>
  800510:	4632                	lw	a2,12(sp)
  800512:	85aa                	mv	a1,a0
  800514:	0074                	addi	a3,sp,12
  800516:	00000517          	auipc	a0,0x0
  80051a:	3c250513          	addi	a0,a0,962 # 8008d8 <error_string+0xc8>
  ...
  800524:	00000917          	auipc	s2,0x0
  800528:	44c90913          	addi	s2,s2,1100 # 800970 <error_string+0x160>
    for (int k = 0; k < 3; k++) {
  80052c:	448d                	li	s1,3
        int pid = fork();
  80052e:	bb5ff0ef          	jal	ra,8000e2 <fork>
        if (pid == 0) {
  800532:	cd0d                	beqz	a0,80056c <main+0x6e>
        waitpid(pid,NULL);
  800534:	4581                	li	a1,0
  800536:	bafff0ef          	jal	ra,8000e4 <waitpid>
        cprintf("[cow_multi-parent] after child%d x=%d\n", k, x);
  80053a:	4632                	lw	a2,12(sp)
  80053c:	85a2                	mv	a1,s0
  80053e:	854a                	mv	a0,s2
    for (int k = 0; k < 3; k++) {
  800540:	2405                	addiw	s0,s0,1
        cprintf("[cow_multi-parent] after child%d x=%d\n", k, x);
  800542:	affff0ef          	jal	ra,800040 <cprintf>
    for (int k = 0; k < 3; k++) {
  800546:	fe9414e3          	bne	s0,s1,80052e <main+0x30>
    }

    cprintf("[cow_multi] parent done pid=%d final x=%d\n", getpid(), x);
  80054a:	b9dff0ef          	jal	ra,8000e6 <getpid>
  80054e:	4632                	lw	a2,12(sp)
  800550:	85aa                	mv	a1,a0
  800552:	00000517          	auipc	a0,0x0
  800556:	44650513          	addi	a0,a0,1094 # 800998 <error_string+0x188>
  80055a:	ae7ff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  80055e:	70a2                	ld	ra,40(sp)
  800560:	7402                	ld	s0,32(sp)
  800562:	64e2                	ld	s1,24(sp)
  800564:	6942                	ld	s2,16(sp)
  800566:	4501                	li	a0,0
  800568:	6145                	addi	sp,sp,48
  80056a:	8082                	ret
            cprintf("[cow_multi-child%d] pid=%d before write x=%d\n", k, getpid(), x);
  80056c:	b7bff0ef          	jal	ra,8000e6 <getpid>
  800570:	46b2                	lw	a3,12(sp)
  800572:	862a                	mv	a2,a0
  800574:	85a2                	mv	a1,s0
  800576:	00000517          	auipc	a0,0x0
  80057a:	39a50513          	addi	a0,a0,922 # 800910 <error_string+0x100>
  80057e:	ac3ff0ef          	jal	ra,800040 <cprintf>
            x = 300 + k;
  800582:	12c4079b          	addiw	a5,s0,300
  800586:	c63e                	sw	a5,12(sp)
            cprintf("[cow_multi-child%d] pid=%d after  write x=%d\n", k, getpid(), x);
  800588:	b5fff0ef          	jal	ra,8000e6 <getpid>
  80058c:	46b2                	lw	a3,12(sp)
  80058e:	862a                	mv	a2,a0
  800590:	85a2                	mv	a1,s0
  800592:	00000517          	auipc	a0,0x0
  800596:	3ae50513          	addi	a0,a0,942 # 800940 <error_string+0x130>
  80059a:	aa7ff0ef          	jal	ra,800040 <cprintf>
            exit(0);
  80059e:	4501                	li	a0,0
  8005a0:	b2dff0ef          	jal	ra,8000cc <exit>
