...
obj/__user_cow_basic.out:     file format elf64-littleriscv
...
exit(int error_code) {
  ...
  8000d8:	4bc50513          	addi	a0,a0,1212 # 800590 <main+0x92>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800132:	47a78793          	addi	a5,a5,1146 # 8005a8 <main+0xaa>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018e:	452a8a93          	addi	s5,s5,1106 # 8005dc <main+0xde>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800196:	666b8b93          	addi	s7,s7,1638 # 8007f8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ec:	1f060613          	addi	a2,a2,496 # 8005d8 <main+0xda>
  ...
  8003fe:	1ce60613          	addi	a2,a2,462 # 8005c8 <main+0xca>
  ...
  800410:	1b440413          	addi	s0,s0,436 # 8005c0 <main+0xc2>
  ...
  80049a:	12a40413          	addi	s0,s0,298 # 8005c0 <main+0xc2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004b0:	115a0a13          	addi	s4,s4,277 # 8005c1 <main+0xc3>
...
int main(void) {
  ...
  800500:	e406                	sd	ra,8(sp)
  800502:	e022                	sd	s0,0(sp)
    cprintf("[cow_basic] start pid=%d x=%d (addr=%p)\n", getpid(), x, &x);
  800504:	be3ff0ef          	jal	ra,8000e6 <getpid>
  800508:	00001417          	auipc	s0,0x1
  80050c:	af840413          	addi	s0,s0,-1288 # 801000 <x>
  800510:	85aa                	mv	a1,a0
  800512:	86a2                	mv	a3,s0
  800514:	00001617          	auipc	a2,0x1
  800518:	aec62603          	lw	a2,-1300(a2) # 801000 <x>
  80051c:	00000517          	auipc	a0,0x0
  800520:	3a450513          	addi	a0,a0,932 # 8008c0 <error_string+0xc8>
  800524:	b1dff0ef          	jal	ra,800040 <cprintf>

    int pid = fork();
  800528:	bbbff0ef          	jal	ra,8000e2 <fork>
    if (pid == 0) {
  80052c:	c505                	beqz	a0,800554 <main+0x56>
        ...
        waitpid(pid, NULL);
  80052e:	4581                	li	a1,0
  800530:	bb5ff0ef          	jal	ra,8000e4 <waitpid>
        cprintf("[cow_basic-parent] pid=%d after child exit x=%d\n", getpid(), x);
  800534:	bb3ff0ef          	jal	ra,8000e6 <getpid>
  800538:	4010                	lw	a2,0(s0)
  80053a:	85aa                	mv	a1,a0
  80053c:	00000517          	auipc	a0,0x0
  800540:	41450513          	addi	a0,a0,1044 # 800950 <error_string+0x158>
  800544:	2601                	sext.w	a2,a2
  800546:	afbff0ef          	jal	ra,800040 <cprintf>
    }
    return 0;
}
  80054a:	60a2                	ld	ra,8(sp)
  80054c:	6402                	ld	s0,0(sp)
  80054e:	4501                	li	a0,0
  800550:	0141                	addi	sp,sp,16
  800552:	8082                	ret
        cprintf("[cow_basic-child] pid=%d before write x=%d\n", getpid(), x);
  800554:	b93ff0ef          	jal	ra,8000e6 <getpid>
  800558:	4010                	lw	a2,0(s0)
  80055a:	85aa                	mv	a1,a0
  80055c:	00000517          	auipc	a0,0x0
  800560:	39450513          	addi	a0,a0,916 # 8008f0 <error_string+0xf8>
  800564:	2601                	sext.w	a2,a2
  800566:	adbff0ef          	jal	ra,800040 <cprintf>
        x = 2;  // should trigger COW
  80056a:	4789                	li	a5,2
  80056c:	c01c                	sw	a5,0(s0)
        cprintf("[cow_basic-child] pid=%d after  write x=%d\n", getpid(), x);
  80056e:	b79ff0ef          	jal	ra,8000e6 <getpid>
  800572:	4010                	lw	a2,0(s0)
  800574:	85aa                	mv	a1,a0
  800576:	00000517          	auipc	a0,0x0
  80057a:	3aa50513          	addi	a0,a0,938 # 800920 <error_string+0x128>
  80057e:	2601                	sext.w	a2,a2
  800580:	ac1ff0ef          	jal	ra,800040 <cprintf>
        exit(0);
  800584:	4501                	li	a0,0
  800586:	b47ff0ef          	jal	ra,8000cc <exit>
