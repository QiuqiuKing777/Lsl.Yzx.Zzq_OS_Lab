...
obj/__user_cow_parent_write.out:     file format elf64-littleriscv
...
exit(int error_code) {
  ...
  8000d8:	4b450513          	addi	a0,a0,1204 # 800588 <main+0x8a>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800132:	47278793          	addi	a5,a5,1138 # 8005a0 <main+0xa2>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018e:	44aa8a93          	addi	s5,s5,1098 # 8005d4 <main+0xd6>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800196:	65eb8b93          	addi	s7,s7,1630 # 8007f0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ec:	1e860613          	addi	a2,a2,488 # 8005d0 <main+0xd2>
  ...
  8003fe:	1c660613          	addi	a2,a2,454 # 8005c0 <main+0xc2>
  ...
  800410:	1ac40413          	addi	s0,s0,428 # 8005b8 <main+0xba>
  ...
  80049a:	12240413          	addi	s0,s0,290 # 8005b8 <main+0xba>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004b0:	10da0a13          	addi	s4,s4,269 # 8005b9 <main+0xbb>
...
int main(void) {
  ...
  800504:	e822                	sd	s0,16(sp)
    int x = 2;
  800506:	c43e                	sw	a5,8(sp)
    cprintf("[cow_parent_write] start pid=%d x=%d (addr=%p)\n", getpid(), x, &x);
  800508:	bdfff0ef          	jal	ra,8000e6 <getpid>
  80050c:	4622                	lw	a2,8(sp)
  80050e:	85aa                	mv	a1,a0
  800510:	0034                	addi	a3,sp,8
  800512:	00000517          	auipc	a0,0x0
  800516:	3a650513          	addi	a0,a0,934 # 8008b8 <error_string+0xc8>
  80051a:	b27ff0ef          	jal	ra,800040 <cprintf>

    int pid = fork();
  80051e:	bc5ff0ef          	jal	ra,8000e2 <fork>
    if (pid == 0) {
  800522:	c905                	beqz	a0,800552 <main+0x54>
    ...
    // parent writes
    x = 200;
  800524:	0c800793          	li	a5,200
  800528:	c43e                	sw	a5,8(sp)
    cprintf("[parent_write-parent] pid=%d wrote x=%d\n", getpid(), x);
  80052a:	842a                	mv	s0,a0
  80052c:	bbbff0ef          	jal	ra,8000e6 <getpid>
  800530:	4622                	lw	a2,8(sp)
  800532:	85aa                	mv	a1,a0
  800534:	00000517          	auipc	a0,0x0
  800538:	3dc50513          	addi	a0,a0,988 # 800910 <error_string+0x120>
  80053c:	b05ff0ef          	jal	ra,800040 <cprintf>

    waitpid(pid,NULL);
  800540:	8522                	mv	a0,s0
  800542:	4581                	li	a1,0
  800544:	ba1ff0ef          	jal	ra,8000e4 <waitpid>
    return 0;
}
  800548:	60e2                	ld	ra,24(sp)
  80054a:	6442                	ld	s0,16(sp)
  80054c:	4501                	li	a0,0
  80054e:	6105                	addi	sp,sp,32
  800550:	8082                	ret
        for (volatile int i = 0; i < 100000; i++);
  800552:	6761                	lui	a4,0x18
  800554:	c602                	sw	zero,12(sp)
  800556:	69f70713          	addi	a4,a4,1695 # 1869f <_start-0x7e7981>
  80055a:	a021                	j	800562 <main+0x64>
  80055c:	47b2                	lw	a5,12(sp)
  80055e:	2785                	addiw	a5,a5,1
  800560:	c63e                	sw	a5,12(sp)
  800562:	47b2                	lw	a5,12(sp)
  800564:	2781                	sext.w	a5,a5
  800566:	fef75be3          	bge	a4,a5,80055c <main+0x5e>
        cprintf("[parent_write-child] pid=%d sees x=%d\n", getpid(), x);
  80056a:	b7dff0ef          	jal	ra,8000e6 <getpid>
  80056e:	4622                	lw	a2,8(sp)
  800570:	85aa                	mv	a1,a0
  800572:	00000517          	auipc	a0,0x0
  800576:	37650513          	addi	a0,a0,886 # 8008e8 <error_string+0xf8>
  80057a:	ac7ff0ef          	jal	ra,800040 <cprintf>
        exit(0);
  80057e:	4501                	li	a0,0
  800580:	b4dff0ef          	jal	ra,8000cc <exit>
